...
gBattleScriptsForMoveEffects:: @ 82D86A8
	...
	.4byte BattleScript_EffectStompingTantrum			@ EFFECT_STOMPING_TANTRUM 			330
	.4byte BattleScript_EffectCoreEnforcer				@ EFFECT_CORE_ENFORCER 				331
	.4byte BattleScript_EffectInstruct					@ EFFECT_INSTRUCT 					332
	.4byte BattleScript_EffectThroatChop				@ EFFECT_THROAT_CHOP 				333
	.4byte BattleScript_EffectLaserFocus				@ EFFECT_LASER_FOCUS 				334
	.4byte BattleScript_EffectMagneticFlux				@ EFFECT_MAGNETIC_FLUX 				335
	.4byte BattleScript_EffectGearUp					@ EFFECT_GEAR_UP 					336
	.4byte BattleScript_EffectIncinerate				@ EFFECT_INCINERATE 				337
	.4byte BattleScript_EffectBugBite					@ EFFECT_BUG_BITE 					338
	.4byte BattleScript_EffectStrengthSap				@ EFFECT_STRENGTH_SAP 				339
	.4byte BattleScript_EffectMindBlown					@ EFFECT_MIND_BLOWN 				340
	.4byte BattleScript_EffectPurify					@ EFFECT_PURIFY 					341
	.4byte BattleScript_EffectBurnUp					@ EFFECT_BURN_UP 					342
	.4byte BattleScript_EffectShoreUp					@ EFFECT_SHORE_UP 					343
	.4byte BattleScript_EffectGeomancy					@ EFFECT_GEOMANCY 					344
	.4byte BattleScript_EffectFairyLock					@ EFFECT_FAIRY_LOCK 				345
	.4byte BattleScript_EffectAllySwitch				@ EFFECT_ALLY_SWITCH 				346
	.4byte BattleScript_EffectSleepHit					@ EFFECT_SLEEP_HIT 					347
	.4byte BattleScript_EffectAttackerDefenseDownHit	@ EFFECT_ATTACKER_DEFENSE_DOWN_HIT 	348
	.4byte BattleScript_EffectBodyPress					@ EFFECT_BODY_PRESS 				349
	.4byte BattleScript_EffectExpandingForce			@ EFFECT_EXPANDING_FORCE 			350
	.4byte BattleScript_EffectScaleShot					@ EFFECT_SCALE_SHOT 				351
	.4byte BattleScript_EffectBeakBlast					@ EFFECT_BEAK_BLAST 				352
	.4byte BattleScript_EffectBoltBeak					@ EFFECT_BOLT_BEAK 					353
	.4byte BattleScript_EffectJungleHealing				@ EFFECT_JUNGLE_HEALING 			354
	.4byte BattleScript_EffectEerieSpell				@ EFFECT_EERIE_SPELL 				355
	.4byte BattleScript_EffectClangorousSoul			@ EFFECT_CLANGOROUS_SOUL 			356
...
BattleScript_TargetStatsWereAllReset::
	printstring STRINGID_TARGETSTATSWERERESET
	waitmessage B_WAIT_TIME_LONG
	return

BattleScript_TargetWasTaunted::
	printstring STRINGID_PKMNFELLFORTAUNT
	waitmessage B_WAIT_TIME_LONG
	return

BattleScript_BattlerBecameXType::
	printstring STRINGID_BATTLERBECAMEXTYPE
	waitmessage B_WAIT_TIME_LONG
	return
...
BattleScript_WildLegendaryMegaEvolution::
	printstring STRINGID_WILDLEGENDARYMEGAEVOLVED
	waitmessage 0x40
	setbyte gIsCriticalHit, 0
	handlemegaevo BS_ATTACKER, 0
	handlemegaevo BS_ATTACKER, 1
...
BattleScript_TargetFormChangeWithStringEnd2::
...
BattleScript_AutoHealActivates::
	printstring STRINGID_AUTOHEALHPUP
...
BattleScript_AttackerMoveRaisedStat::
	playanimation BS_ATTACKER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	printstring STRINGID_ATTACKERMOVERAISEDSTAT
	waitmessage 0x40
	end3

BattleScript_SignatureMoveSetStickyWeb::
	printstring STRINGID_STICKYWEBUSED
	waitmessage 0x40
	end3

BattleScript_SignatureMoveSetStealthRock::
	printstring STRINGID_POINTEDSTONESFLOAT
	waitmessage 0x40
	end3

BattleScript_SignatureMoveSetSpikes::
	printstring STRINGID_SPIKESSCATTERED
	waitmessage 0x40
	end3

BattleScript_SignatureMoveSetToxicSpikes::
	printstring STRINGID_POISONSPIKESSCATTERED
	waitmessage 0x40
	end3

BattleScript_SignatureMoveSetTailwind::
	printstring STRINGID_TAILWINDBLEW
	waitmessage 0x40
	end3

BattleScript_TheWeatherBecameSunny::
	playmoveanimation BS_ATTACKER, MOVE_SUNNY_DAY
	printstring STRINGID_SUNLIGHTGOTBRIGHT
	waitmessage 0x40
	end3

BattleScript_TheWeatherBecameRainy::
	playmoveanimation BS_ATTACKER, MOVE_RAIN_DANCE
	printstring STRINGID_STARTEDTORAIN
	waitmessage 0x40
	end3

BattleScript_TheWeatherBecameSandstorm::
	playmoveanimation BS_ATTACKER, MOVE_SANDSTORM
	printstring STRINGID_SANDSTORMBREWED
	waitmessage 0x40
	end3

BattleScript_TheWeatherBecameHail::
	playmoveanimation BS_ATTACKER, MOVE_HAIL
	printstring STRINGID_STARTEDHAIL
	waitmessage 0x40
	end3

BattleScript_SetElectricTerrain::
	playmoveanimation BS_ATTACKER, MOVE_ELECTRIC_TERRAIN
	printstring STRINGID_TERRAINBECOMESELECTRIC
	waitmessage 0x40
	end3

BattleScript_SetPsychicTerrain::
	playmoveanimation BS_ATTACKER, MOVE_PSYCHIC_TERRAIN
	printstring STRINGID_TERRAINBECOMESPSYCHIC
	waitmessage 0x40
	end3

BattleScript_SetMistyTerrain::
	playmoveanimation BS_ATTACKER, MOVE_MISTY_TERRAIN
	printstring STRINGID_TERRAINBECOMESMISTY
	waitmessage 0x40
	end3

BattleScript_SetGrassyTerrain::
	playmoveanimation BS_ATTACKER, MOVE_GRASSY_TERRAIN
	printstring STRINGID_TERRAINBECOMESGRASSY
	waitmessage 0x40
	end3
	
BattleScript_AttackerMoveSetsStatusEffect::
	waitstate
	seteffectsecondary
	return
...
BattleScript_EffectColorChange::
	call BattleScript_AbilityPopUp
...
BattleScript_EffectMagneticBody::
	copybyte gBattlerAbility, gBattlerAttacker
	call BattleScript_AbilityPopUp
	printstring STRINGID_PKMNLEVITATEDONELECTROMAGNETISM
	waitmessage 0x40
...
BattleScript_EffectCoiledUp::
	copybyte gBattlerAbility, gBattlerAttacker
	call BattleScript_AbilityPopUp
	printstring STRINGID_BATTLERISREADYTOBITE
	waitmessage 0x40
	end3
	
BattleScript_EffectRooted::
	copybyte gBattlerAbility, gBattlerAttacker
	call BattleScript_AbilityPopUp
	printstring STRINGID_PKMNPLANTEDROOTS
	waitmessage 0x40
...
BattleScript_ShootingStarActivate::
	copybyte gBattlerAbility, gBattlerAttacker
	call BattleScript_AbilityPopUp
...
BattleScript_EffectGravitation::
	copybyte gBattlerAbility, gBattlerAttacker
	call BattleScript_AbilityPopUp
	waitanimation
	printstring STRINGID_GRAVITYINTENSIFIED
...
BattleScript_EffectAuroraBody::
	copybyte gBattlerAbility, gBattlerAttacker
	call BattleScript_AbilityPopUp
	playmoveanimation BS_ATTACKER, MOVE_AURORA_VEIL
	waitanimation
	setauroraveil BS_ATTACKER
	printstring STRINGID_PROTECTIVEVIELCREATED
	waitmessage 0x40
	end3
	
BattleScript_EffectScreenSetter::
	copybyte gBattlerAbility, gBattlerAttacker
	call BattleScript_AbilityPopUp
	playmoveanimation BS_ATTACKER, MOVE_REFLECT
	waitanimation
	setreflect
	printstring STRINGID_PROTECTIVESCREENCREATED
	waitmessage 0x40
	end3
	
BattleScript_EffectLooseQuills::
	call BattleScript_AbilityPopUp
...
BattleScript_EffectBattery::
	call BattleScript_AbilityPopUp
	playmoveanimation BS_ATTACKER, MOVE_CHARGE
	waitanimation
	setstatchanger STAT_SPDEF, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_BUFF_ALLOW_PTR, BattleScript_EffectChargeString
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, 0x2, BattleScript_EffectChargeString
...
BattleScript_SecondHitHurtTarget:
	orword gHitMarker, HITMARKER_IGNORE_SUBSTITUTE | HITMARKER_x100000
	healthbarupdate BS_TARGET
	datahpupdate BS_TARGET
	printstring STRINGID_ATTACKERSECONDHIT
	waitmessage 0x40
	tryfaintmon BS_TARGET, FALSE, NULL
	return

BattleScript_AttackerSecondHitActivates::
	call BattleScript_AbilityPopUp
	call BattleScript_SecondHitHurtTarget
	return
...
BattleScript_BattlerAttackInfauationOnHit::
	status2animation BS_TARGET, STATUS2_INFATUATION
	printstring STRINGID_PKMNFELLINLOVE
	waitmessage 0x40
	call BattleScript_TryDestinyKnotTarget
...
BattleScript_BattlerAttackSeededOnHit::
	printstring STRINGID_PKMNSEEDED
	waitmessage 0x40
	return

BattleScript_BattlerAttackCursedOnHit::
...
BattleScript_BattlerAttackConfusesOnHit::
	setmoveeffect MOVE_EFFECT_CONFUSION
	seteffectprimary
	resultmessage
	waitmessage 0x40
