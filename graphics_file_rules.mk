...
NEWUIGFXDIR := graphics/ui_menu

types := normal fight flying poison ground rock bug ghost steel mystery fire water grass electric psychic ice dragon dark fairy cosmic alcohol food
...
graphics/pokenav/region_map_kanto/region_map.8bpp: %.8bpp: %.png
	$(GFX) $< $@ -num_tiles 232
...
$(PSSGFXDIR)/barireefer.4bpp: $(PSSGFXDIR)/friends_frame2.4bpp $(PSSGFXDIR)/barireefer_bg.4bpp
	@cat $^ >$@
...
$(NEWUIGFXDIR)/start_menu/mode_selection.4bpp: %.4bpp: %.png
	@cat $^ >$@
