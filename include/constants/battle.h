...
#define BATTLE_TYPE_KRAKRUM_NOIRNET  (1 << 12)
...
#define BATTLE_TYPE_NOIRNET         (1 << 28)
#define BATTLE_TYPE_KRAKRUM          (1 << 29)
#define BATTLE_TYPE_TOWERMASTA        (1 << 30)
...
#define STATUS1_INTOXICATE       (1 << 12)
...
#define STATUS_FIELD_INVERSE_ROOM       0x1000
...
#define WEATHER_RAIN_PRIMAL         (1 << 10)
