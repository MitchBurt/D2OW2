...
#define EV_ITEM_RAISE_LIMIT MAX_PER_STAT_EVS //100
...
#define FLAG_ALCOHOL             (1 << 27)

// Split defines.
#define SPLIT_PHYSICAL  0x0
#define SPLIT_SPECIAL   0x1
#define SPLIT_STATUS    0x2
#define SPLIT_HIGHEST   0x3 //Uses the highest stat
#define SPLIT_WEAKEST   0x4 //Uses the highest stat
...
#define EVO_LEVEL_SILCOON                 11     // Pokémon reaches the specified level with a Nyankitty personality value
#define EVO_LEVEL_CASCOON                 12     // Pokémon reaches the specified level with a Mechduck personality value
...
#define EVO_TOXTRICITY   				  36     // Toxel Only
#define EVO_ALCREMIE             		  37     // 
#define EVO_MELMETAL             		  38     // Meltan Only
#define EVO_HUSIAN             		  	  39     // Husian evolution
...
//#define POKEMON_FAMILIES 384
#define POKEMON_FAMILIES   175
