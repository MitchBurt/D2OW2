...
#define MAP_BATTLE_SCENE_JACK       4
#define MAP_BATTLE_SCENE_GREGORIUS       5
#define MAP_BATTLE_SCENE_THANATOS       6
#define MAP_BATTLE_SCENE_SHINJI        7
#define MAP_BATTLE_SCENE_FRONTIER     8
#define MAP_BATTLE_SCENE_LEADER       9
#define MAP_BATTLE_SCENE_DARIO      10
#define MAP_BATTLE_SCENE_NOIRNET      11
#define MAP_BATTLE_SCENE_KRAKRUM       12
#define MAP_BATTLE_SCENE_TOWERMASTA     13
