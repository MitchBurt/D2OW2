...
static const u16 gSpeciesLookUpTable[] = 
{
    ...
    [SPECIES_WHISKBALL] = 283,
    [SPECIES_CINAMANCER] = 284,
    [SPECIES_BLINKY] = 285,
    ...
    [SPECIES_AZURILL] = 298,
    [SPECIES_SCATRUSH] = 299,
    [SPECIES_SMOSLIME] = 300,
    [SPECIES_NYANCAT] = 301,
    [SPECIES_SECRITLER] = 302,
    ...
    [SPECIES_PURRSOUR] = 311,
    [SPECIES_PURRTANG] = 312,
    [SPECIES_REWINDLE] = 313,
    [SPECIES_DNDICE] = 314,
    [SPECIES_ALIEON] = 315,
    [SPECIES_SYMBITE] = 316,
    ...
    [SPECIES_BREWFIN] = 318,
    [SPECIES_SHARKEG] = 319,
    [SPECIES_SHRIMPOT] = 320,
    [SPECIES_LOBSCALD] = 321,
    ...
    [SPECIES_YELTZER] = 327,
    [SPECIES_METIORE] = 328,
    [SPECIES_COMETIDE] = 329,
    [SPECIES_GALADRAKE] = 330,
    [SPECIES_YOLKANNER] = 331,
    [SPECIES_ACONEGGS] = 332,
    [SPECIES_ARMYDRONE] = 333,
    [SPECIES_UNSC] = 334,
    [SPECIES_SMITNION] = 335,
    [SPECIES_ARACKNE] = 336,
    [SPECIES_SURTYUR] = 337,
    [SPECIES_GANESH] = 338,
    [SPECIES_COOPID] = 339,
    [SPECIES_SPLASHICOOT] = 340,
    [SPECIES_NONGETIVE] = 341,
    [SPECIES_NONONMON] = 342,
    [SPECIES_DREIDRILL] = 343,
    [SPECIES_HEBURROW] = 344,
    [SPECIES_ODOSAUR] = 345,
    [SPECIES_PYRABASS] = 346,
    [SPECIES_TRICERAS] = 347,
    [SPECIES_XENOTOPS] = 348,
    [SPECIES_PADDLITE] = 349,
    [SPECIES_NUTVALANCHE] = 350,
    [SPECIES_CASTFORM] = 351,
    [SPECIES_KECLEON] = 352,
    [SPECIES_TICKTOWEL] = 353,
    [SPECIES_TOCKTOWER] = 354,
    [SPECIES_RATMAN] = 355,
    [SPECIES_HUGEMAN] = 356,
    [SPECIES_TROPIUS] = 357,
    [SPECIES_KIRBAIRDE] = 358,
    [SPECIES_FREDBAR] = 359,
    [SPECIES_BABINION] = 360,
    [SPECIES_CHAIROLD] = 361,
    [SPECIES_ELECHAIR] = 362,
    [SPECIES_PIRAGHOUL] = 363,
    [SPECIES_MORGHOST] = 364,
    [SPECIES_PHASMORGAN] = 365,
    [SPECIES_GOLBNAR] = 366,
    [SPECIES_GLOBNAUT] = 367,
    [SPECIES_THAUMNAR] = 368,
    [SPECIES_GALACNAR] = 369,
    [SPECIES_WARPNAR] = 370,
    [SPECIES_SIPKING] = 371,
    [SPECIES_TIPSYRAMID] = 372,
    [SPECIES_DRUNKABUS] = 373,
    [SPECIES_YELLEYE] = 374,
    [SPECIES_HARASTUR] = 375,
    [SPECIES_HAZETHOTH] = 376,
    [SPECIES_BEERIO] = 377,
    [SPECIES_REGICE] = 378,
    [SPECIES_NAWFFLE] = 379,
    [SPECIES_STINGWELL] = 380,
    [SPECIES_TROJOLIN] = 381,
    [SPECIES_KRAKRUM] = 382,
    [SPECIES_NOIRNET] = 383,
    [SPECIES_TOWERMASTA] = 384,
    [SPECIES_THISCRAKER] = 385,
    [SPECIES_SQUILITHID] = 386,
};
