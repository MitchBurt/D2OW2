...
#define RESOURCE_FLAG_ICE_FACE 0x40
...
#define IS_BATTLER_MOVE_PHYSICAL(move, battlerId)(GetBattleMoveSplitFromBattler(move, battlerId) == SPLIT_PHYSICAL)
#define IS_BATTLER_MOVE_SPECIAL(move, battlerId)(GetBattleMoveSplitFromBattler(move, battlerId) == SPLIT_SPECIAL)
