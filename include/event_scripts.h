...
extern const u8 RustboroCity_Gym_EventScript_RegisterMason[];
extern const u8 MossdeepCity_SpaceCenter_2F_EventScript_RivalTowermastaCall[];
extern const u8 SSTidalCorridor_EventScript_ReachedStepCount[];
extern const u8 EventScript_FallDownHoleMtPyre[];
extern const u8 EventScript_Gym_Attendant_Call[];
...
//Followers
extern const u8 EventScript_Normal_Follower[];
extern const u8 EventScript_Flying_Follower[];
...
extern const u8 EventScript_FollowerPickup[];
extern const u8 EventScript_FollowerDislikesThisPlace[];
extern const u8 EventScript_FollowerHappySnow[];
extern const u8 EventScript_FollowerLikesThisPlace[];
extern const u8 EventScript_FollowerHoldingItem[];
extern const u8 EventScript_FollowerPresent_1[];
extern const u8 EventScript_FollowerPresent_2[];
