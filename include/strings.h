...
extern const u8 gText_Options_AcroBike[];
extern const u8 gText_Options_MachBike[];
...
extern const u8 gText_MainMenuSoundTest[];
...
extern const u8 gText_BurntonionDoll32BP[];
extern const u8 gText_FilmbrainDoll48BP[];
extern const u8 gText_GarfelDoll48BP[];
extern const u8 gText_EgoirlDoll48BP[];
extern const u8 gText_DittoDoll48BP[];
extern const u8 gText_MegatronDoll80BP[];
extern const u8 gText_TomDoll80BP[];
extern const u8 gText_KorbieDoll80BP[];

extern const u8 gText_JebonyDoll128BP[];
extern const u8 gText_ShepeirdDoll128BP[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_BurntonionDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_FilmbrainDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_GarfelDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_EgoirlDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_DittoDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_MegatronDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_TomDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_KorbieDollDesc[];
...
extern const u8 gText_Dario[];
extern const u8 gText_Steven[];
extern const u8 gText_Zach[];
extern const u8 gText_Tanner[];
extern const u8 gText_Gregorius[];
extern const u8 gText_Thanatos[];
...
extern const u8 gTrickHouse_Mechadoll_Bongstard[];
...
extern const u8 gTrickHouse_Mechadoll_Notafurry[];
extern const u8 gTrickHouse_Mechadoll_Meowrrior[];
extern const u8 gTrickHouse_Mechadoll_Doobob[];
extern const u8 gTrickHouse_Mechadoll_Duplicat2[];
extern const u8 gTrickHouse_Mechadoll_Blinky[];
...
extern const u8 gText_BerryalenDollAndPrice[];
extern const u8 gText_CookletDollAndPrice[];
extern const u8 gText_BaitordDollAndPrice[];
...
extern const u8 gText_ParangeliaBerryPicking[];
...
extern const u8 MatchCall_Text_Rick1[];
extern const u8 MatchCall_Text_Rick2[];
extern const u8 MatchCall_Text_Rick3[];
extern const u8 MatchCall_Text_Rick4[];
extern const u8 MatchCall_Text_Rick5[];
extern const u8 MatchCall_Text_Rick6[];
extern const u8 MatchCall_Text_Rick7[];
extern const u8 MatchCall_Text_Rick8[];
extern const u8 MatchCall_Text_Rick9[];
...
extern const u8 MatchCall_Text_Mason1[];
extern const u8 MatchCall_Text_Mason2[];
extern const u8 MatchCall_Text_Mason3[];
extern const u8 MatchCall_Text_Mason4[];
extern const u8 MatchCall_Text_Zach1[];
extern const u8 MatchCall_Text_Zach2[];
extern const u8 MatchCall_Text_Zach3[];
extern const u8 MatchCall_Text_Zach4[];
extern const u8 MatchCall_Text_Trevor1[];
extern const u8 MatchCall_Text_Trevor2[];
extern const u8 MatchCall_Text_Trevor3[];
extern const u8 MatchCall_Text_Trevor4[];
extern const u8 MatchCall_Text_Jared1[];
extern const u8 MatchCall_Text_Jared2[];
extern const u8 MatchCall_Text_Jared3[];
extern const u8 MatchCall_Text_Jared4[];
extern const u8 MatchCall_Text_Tanner1[];
extern const u8 MatchCall_Text_Tanner2[];
extern const u8 MatchCall_Text_Tanner3[];
extern const u8 MatchCall_Text_Tanner4[];
...
extern const u8 MatchCall_Text_Mitchell1[];
...
extern const u8 MatchCall_Text_Thanatos[];
extern const u8 MatchCall_Text_Shinji[];
extern const u8 MatchCall_Text_Dario[];
...
extern const u8 gText_RickMatchCallDesc[];
extern const u8 gText_RickMatchCallName[];
...
extern const u8 gText_MasonMatchCallDesc[];
extern const u8 gText_ZachMatchCallDesc[];
extern const u8 gText_TrevorMatchCallDesc[];
extern const u8 gText_JaredMatchCallDesc[];
extern const u8 gText_TannerMatchCallDesc[];
extern const u8 gText_TateLizaMatchCallDesc[];
extern const u8 gText_MitchellMatchCallDesc[];
...
extern const u8 gText_JackChangeCostume[];
extern const u8 gText_JackWonderTrade[];
extern const u8 gText_Relearn_Move[];
extern const u8 gText_Egg_Tutor[];
extern const u8 gText_Move_Tutor[];
extern const u8 gText_TM_Tutor[];
...
extern const u8 gText_Costume_Emerald[];
extern const u8 gText_Costume_RubySapphire[];
extern const u8 gText_Costume_FRLG[];
extern const u8 gText_Costume_BW[];

extern const u8 gText_AshQty[];

extern const u8 gText_Region_BGM[];
...
extern const u8 gText_Difficulty_PC_Storage[];
extern const u8 gText_Difficulty_Password[];
...
extern const u8 gText_Game_Modes_More[];
extern const u8 gText_Game_Modes_No_Evo[];
extern const u8 gText_Game_Modes_Leveless[];
extern const u8 gText_Game_Modes_No_Mega[];
extern const u8 gText_Game_Modes_No_Split[];
extern const u8 gText_Game_Modes_Leveless[];
extern const u8 gText_Game_Modes_Vanilla[];

extern const u8 gText_Companion_Trainer_Password[];

extern const u8 gText_Game_Modes_Randomized_Enable[];
extern const u8 gText_Game_Modes_Randomized_Full_Enable[];

extern const u8  gText_Default[];
extern const u8  gText_ColorRed[];
extern const u8  gText_CapColorBlue[];
extern const u8  gText_ColorYellow[];
extern const u8  gText_ColorGreen[];
extern const u8  gText_ColorBlack[];
extern const u8  gText_ColorBrown[];
extern const u8  gText_ColorPurple[];
extern const u8  gText_ColorGray[];
...
//point of contact
extern const u8 gText_SideQuestHint_1[];
extern const u8 gText_SideQuestHint_2[];
extern const u8 gText_SideQuestHint_3[];
extern const u8 gText_SideQuestHint_4[];
extern const u8 gText_SideQuestHint_5[];
extern const u8 gText_SideQuestHint_6[];
extern const u8 gText_SideQuestHint_7[];
extern const u8 gText_SideQuestHint_8[];
extern const u8 gText_SideQuestHint_9[];
extern const u8 gText_SideQuestHint_10[];
extern const u8 gText_SideQuestHint_11[];
extern const u8 gText_SideQuestHint_12[];
extern const u8 gText_SideQuestHint_13[];
extern const u8 gText_SideQuestHint_14[];
extern const u8 gText_SideQuestHint_15[];
extern const u8 gText_SideQuestHint_16[];
extern const u8 gText_SideQuestHint_17[];
extern const u8 gText_SideQuestHint_18[];
extern const u8 gText_SideQuestHint_19[];
extern const u8 gText_SideQuestHint_20[];
extern const u8 gText_SideQuestHint_21[];
extern const u8 gText_SideQuestHint_22[];
extern const u8 gText_SideQuestHint_23[];
extern const u8 gText_SideQuestHint_24[];
extern const u8 gText_SideQuestHint_25[];
extern const u8 gText_SideQuestHint_26[];
extern const u8 gText_SideQuestHint_27[];
extern const u8 gText_SideQuestHint_28[];
extern const u8 gText_SideQuestHint_29[];
extern const u8 gText_SideQuestHint_30[];

extern const u8 gText_Pokedex_Ability0[];
