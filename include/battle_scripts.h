...
extern const u8 BattleScript_AutoHealActivates[];
...
extern const u8 BattleScript_TargetFormChangeWithStringEnd2[];
extern const u8 BattleScript_SelectingNotAllowedMoveGorillaTactics[];
extern const u8 BattleScript_ItemDropped[];
extern const u8 BattleScript_EffectAirCurrent[];
extern const u8 BattleScript_EffectTrickster[];
extern const u8 BattleScript_EffectOppositeDay[];
extern const u8 BattleScript_EffectAuroraBody[];
extern const u8 BattleScript_EffectScreenSetter[];
extern const u8 BattleScript_EffectLooseQuills[];
extern const u8 BattleScript_EffectWaterSpill[];
extern const u8 BattleScript_EffectBattery[];
extern const u8 BattleScript_EffectIlluminate[];
extern const u8 BattleScript_EffectColorChange[];
extern const u8 BattleScript_EffectDreamWorld[];
extern const u8 BattleScript_EffectRooted[];
extern const u8 BattleScript_EffectMagneticBody[];
...
extern const u8 BattleScript_EffectCoiledUp[];
extern const u8 BattleScript_EffectGravitation[];
extern const u8 BattleScript_AttackerMoveRaisedStat[];
extern const u8 BattleScript_AttackerMoveSetsStatusEffect[];
...
extern const u8 BattleScript_SignatureMoveSetStickyWeb[];
extern const u8 BattleScript_BattlerAttackStatLowerOnHit[];
extern const u8 BattleScript_BattlerAttackConfusesOnHit[];
extern const u8 BattleScript_PickUpActivate[];
extern const u8 BattleScript_SignatureMoveSetStealthRock[];
extern const u8 BattleScript_AttackerMoveSetsPrimaryStatusEffect[];
...
extern const u8 BattleScript_SignatureMoveSetSpikes[];
extern const u8 BattleScript_SignatureMoveSetToxicSpikes[];
extern const u8 BattleScript_BattlerAttackInfauationOnHit[];
extern const u8 BattleScript_BattlerAttackSeededOnHit[];
extern const u8 BattleScript_TargetStatsWereAllReset[];
extern const u8 BattleScript_SignatureMoveSetTailwind[];
extern const u8 BattleScript_TargetWasTaunted[];
extern const u8 BattleScript_BattlerBecameXType[];
extern const u8 BattleScript_TheWeatherBecameSunny[];
extern const u8 BattleScript_TheWeatherBecameRainy[];
extern const u8 BattleScript_TheWeatherBecameSandstorm[];
extern const u8 BattleScript_TheWeatherBecameHail[];
extern const u8 BattleScript_SetElectricTerrain[];	
...
extern const u8 BattleScript_MoveIsIntoxicateNoMore[];
