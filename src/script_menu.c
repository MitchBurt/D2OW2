...
//Starter Selection -------------------------------------------------------------------------
static const u8 sText_Starter_1[] = _("Berryalen");
static const u8 sText_Starter_2[] = _("Cooklet");
static const u8 sText_Starter_3[] = _("Baitord");
static const u8 sText_Starter_4[] = _("Duplicat");
static const u8 sText_Starter_5[] = _("Filmbrain");
static const u8 sText_Starter_6[] = _("Alcoo");
static const u8 sText_Starter_7[] = _("Skorchi");
static const u8 sText_Starter_8[] = _("Jissm");
static const u8 sText_Starter_9[] = _("Meadosaur");
