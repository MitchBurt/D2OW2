...
//Starter Selection -------------------------------------------------------------------------
static const u8 sText_Starter_1[] = _("Garfel");
static const u8 sText_Starter_2[] = _("Skorchi");
static const u8 sText_Starter_3[] = _("Jissm");
static const u8 sText_Starter_4[] = _("Meadosaur");
...
static const u8 sText_Starter_9[] = _("Gahnomed");
