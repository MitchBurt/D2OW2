...
void LoadPokemonCompressedSpritePalette(u8 r, u8 g, u8 b, const struct CompressedSpritePalette *src)
{
    struct SpritePalette dest;
    ...
    dest.data = (void*) gDecompressionBuffer;
    dest.tag = src->tag;
    LoadPokemonSpritePalette(r, g, b, &dest);
}
...
const struct SpritePalette DecompressSpritePaletteOverrideBuffer(const struct CompressedSpritePalette *a, void *buffer)
{
