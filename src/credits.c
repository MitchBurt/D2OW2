...
static const u8 gCreditsText_NationalFederationBlind[] = _("Brixelwott");
static const u8 gCreditsText_PatriciaAMaurer[] = _("KaiaWolf");
static const u8 gCreditsText_EuropeanBlindUnion[] = _("TheXaman, AsparagusEdu, Ghoulslash, Merrp");
static const u8 gCreditsText_AustralianBrailleAuthority[] = _("Lunos, CyanSMP64, Drayano, Jaizu");
static const u8 gCreditsText_RoyalNewZealandFederationBlind[] = _("Josh, Zef, RH-Hideout and Pret Team");
