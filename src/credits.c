...
static const u8 gCreditsText_PkmnEmeraldVersion[] = _("Pokémon Dario 2");
...
static const u8 gCreditsText_BrailleCodeCheck[] = _("D.R.L.O Developers");
...
static const u8 gCreditsText_JapanBrailleLibrary[] = _("Bee-rye");
...
static const u8 gCreditsText_NationalFederationBlind[] = _("TMG");
static const u8 gCreditsText_PatriciaAMaurer[] = _("TMG");
static const u8 gCreditsText_EuropeanBlindUnion[] = _("Tower Mster Games");
static const u8 gCreditsText_AustralianBrailleAuthority[] = _("Mitchell Burt");
static const u8 gCreditsText_RoyalNewZealandFederationBlind[] = _("Uncle Bunga");
static const u8 gCreditsText_MotoyasuTojima[] = _("TMG");
static const u8 gCreditsText_NicolaPrattBarlow[] = _("TMG");
static const u8 gCreditsText_ShellieDow[] = _("TMG");
static const u8 gCreditsText_ErikJohnson[] = _("TMG");
...
void CB2_StartCreditsSequence(void)
{
    ...
    m4aSongNumStart(RegionalMusicHandler(MUS_CREDITS));
...
static void Task_CreditsTheEnd6(u8 taskIdA)
{
    if (!gPaletteFade.active)
    {
        ...
        if (gTasks[taskIdA].data[TDA_0] == 6840)
            m4aSongNumStart(RegionalMusicHandler(MUS_END));
...
static void DeterminePokemonToShow(void)
{
    u16 starter = SpeciesToNationalPokedexNum(GetStarterPokemon(VarGet(VAR_STARTER_MON))); // handle forms
    u16 page;
    u16 dexNum;
    u16 j;
