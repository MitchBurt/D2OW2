...
{
    SPECIES_THEVOID, SPECIES_GOD, SPECIES_SUFFER, SPECIES_HELPME, SPECIES_LILGUY,
    SPECIES_KRAKRUM, SPECIES_NOIRNET, SPECIES_TOWERMASTA, SPECIES_THISCRAKER, SPECIES_SQUILITHID, 0xFFFF
};
