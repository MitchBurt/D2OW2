...
#define SOUND_LIST_BGM \
    ...
    X(MUS_WEATHER_KRAKRUM, "MUS-WEATHER-KRAKRUM") \
    X(MUS_WEATHER_NOIRNET, "MUS-WEATHER-NOIRNET") \
    ...
    X(MUS_VS_KRAKRUM_NOIRNET, "MUS-VS-KRAKRUM-NOIRNET") \
    ...
    X(MUS_RG_SNEDDIT, "MUS-RG-SNEDDIT") \
    ...
    X(MUS_RG_VS_SQUILITHID, "MUS-RG-VS-SQUILITHID") \
    X(MUS_RG_VS_GOD, "MUS-RG-VS-GOD") \
    X(MUS_RG_VS_LEGEND, "MUS-RG-VS-LEGEND") \
    X(MUS_RG_ENCOUNTER_GYM_LEADER, "MUS-RG-ENCOUNTER-GYM-LEADER") \
    X(MUS_RG_ENCOUNTER_SQUILITHID, "MUS-RG-ENCOUNTER-SQUILITHID") \
    ...
    X(MUS_TOWERMASTA_APPEARS, "MUS-TOWERMASTA-APPEARS") \
    ...
    X(MUS_VS_TOWERMASTA, "MUS-VS-TOWERMASTA") \
...
#define SOUND_LIST_SE \
    ...
    X(SE_RG_SQUILITHID_MOVE, "SE-RG-SQUILITHID-MOVE") \
    ...
    X(SE_BREADDIE_SHAKE, "SE-BREADDIE-SHAKE") \
