...
const u16 gSpeciesToHoennPokedexNum[NUM_SPECIES] = // Assigns all species to the Hoenn Dex Index (Summary No. for Hoenn Dex)
{
    ...
    SPECIES_TO_HOENN(STINGWELL),
    SPECIES_TO_HOENN(TROJOLIN),
...
const u16 gSpeciesToNationalPokedexNum[NUM_SPECIES] = // Assigns all species to the National Dex Index (Summary No. for National Dex)
{
    ...
    SPECIES_TO_NATIONAL(POSSQUAD),
    SPECIES_TO_NATIONAL(POSSWARM),
    SPECIES_TO_NATIONAL(CHEETORCH),
    SPECIES_TO_NATIONAL(SPICHEETAH),
    ...
    SPECIES_TO_NATIONAL(UNGGRUNT),
    SPECIES_TO_NATIONAL(SANGBLADE),
    ...
    SPECIES_TO_NATIONAL(EQUEMBRYO),
    SPECIES_TO_NATIONAL(TERRIPEDE),
    ...
    SPECIES_TO_NATIONAL(TOWERMASTA),
    SPECIES_TO_NATIONAL(RISKPOPOLY),
    SPECIES_TO_NATIONAL(BEERIO),
    SPECIES_TO_NATIONAL(SQUILITHID),
    SPECIES_TO_NATIONAL(LASONYX),
    SPECIES_TO_NATIONAL(STINGWELL),
    SPECIES_TO_NATIONAL(TROJOLIN),
   ...
   /* SPECIES_TO_NATIONAL(VICTINI),
    ...
    [SPECIES_STINGWELL_MEGA - 1] = NATIONAL_DEX_STINGWELL,
    [SPECIES_TROJOLIN_MEGA - 1] = NATIONAL_DEX_TROJOLIN,
...
const u16 gHoennToNationalOrder[HOENN_DEX_COUNT] = // Assigns Hoenn Dex Pokémon (Using National Dex Index)
{
    ...
    HOENN_TO_NATIONAL(STINGWELL),
    HOENN_TO_NATIONAL(TROJOLIN),
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_STINGWELL - 1] = 0x2d,
    [SPECIES_TROJOLIN - 1] = 0x10,
    ...
    [SPECIES_CHEETORCH - 1] = 0x1C,
    [SPECIES_SPICHEETAH - 1] = 0x1C,
    ...
    [SPECIES_UNGGRUNT - 1] = 0x4E,
    [SPECIES_SANGBLADE - 1] = 0x51,
