...
const u16 gSpeciesToNationalPokedexNum[NUM_SPECIES] = // Assigns all species to the National Dex Index (Summary No. for National Dex)
{
   ...
   /* SPECIES_TO_NATIONAL(VICTINI),
    ...
    [SPECIES_BERRORD_MEGA - 1] = NATIONAL_DEX_BERRORD,
    [SPECIES_FAZEAGLE_MEGA - 1] = NATIONAL_DEX_FAZEAGLE,
    [SPECIES_KUKLOPS_MEGA - 1] = NATIONAL_DEX_KUKLOPS,
    [SPECIES_SHEMUE_MEGA - 1] = NATIONAL_DEX_SHEMUE,
    [SPECIES_SANS_MEGA - 1] = NATIONAL_DEX_SANS,
    [SPECIES_TROLOLO_MEGA - 1] = NATIONAL_DEX_TROLOLO,
    [SPECIES_ITRIMID_MEGA - 1] = NATIONAL_DEX_ITRIMID,
    [SPECIES_KROLLER_MEGA - 1] = NATIONAL_DEX_KROLLER,
    [SPECIES_USARMY_MEGA - 1] = NATIONAL_DEX_USARMY,
    [SPECIES_GOD_MEGA_X - 1] = NATIONAL_DEX_GOD,
    [SPECIES_GOD_MEGA_Y - 1] = NATIONAL_DEX_GOD,
    [SPECIES_BACID_MEGA - 1] = NATIONAL_DEX_BACID,
    [SPECIES_HOLOCAST_MEGA - 1] = NATIONAL_DEX_HOLOCAST,
    [SPECIES_NUGGIE_MEGA - 1] = NATIONAL_DEX_NUGGIE,
    [SPECIES_HAPPYMAUL_MEGA - 1] = NATIONAL_DEX_HAPPYMAUL,
    [SPECIES_MINIMAL_MEGA - 1] = NATIONAL_DEX_MINIMAL,
    [SPECIES_FROSILISK_MEGA - 1] = NATIONAL_DEX_FROSILISK,
    ...
    [SPECIES_THATSFURRY_MEGA - 1] = NATIONAL_DEX_THATSFURRY,
