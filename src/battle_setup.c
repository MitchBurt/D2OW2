...
EWRAM_DATA bool8 gMonotypeCannotCatch = 0;
...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_MASON] = REMATCH(TRAINER_MASON_1, TRAINER_MASON_2, TRAINER_MASON_3, TRAINER_MASON_4, TRAINER_MASON_5, RUSTBORO_CITY),
    [REMATCH_ZACH] = REMATCH(TRAINER_ZACH_1, TRAINER_ZACH_2, TRAINER_ZACH_3, TRAINER_ZACH_4, TRAINER_ZACH_5, DEWFORD_TOWN),
    [REMATCH_TREVOR] = REMATCH(TRAINER_TREVOR_1, TRAINER_TREVOR_2, TRAINER_TREVOR_3, TRAINER_TREVOR_4, TRAINER_TREVOR_5, MAUVILLE_CITY),
    [REMATCH_JARED] = REMATCH(TRAINER_JARED_1, TRAINER_JARED_2, TRAINER_JARED_3, TRAINER_JARED_4, TRAINER_JARED_5, LAVARIDGE_TOWN),
    [REMATCH_RICK] = REMATCH(TRAINER_RICK_1, TRAINER_RICK_2, TRAINER_RICK_3, TRAINER_RICK_4, TRAINER_RICK_5, PETALBURG_CITY),
    [REMATCH_TANNER] = REMATCH(TRAINER_TANNER_1, TRAINER_TANNER_2, TRAINER_TANNER_3, TRAINER_TANNER_4, TRAINER_TANNER_5, FORTREE_CITY),
    [REMATCH_TONY_AND_SAL] = REMATCH(TRAINER_TONY_AND_SAL_1, TRAINER_TONY_AND_SAL_2, TRAINER_TONY_AND_SAL_3, TRAINER_TONY_AND_SAL_4, TRAINER_TONY_AND_SAL_5, MOSSDEEP_CITY),
    [REMATCH_MITCHELL] = REMATCH(TRAINER_MITCHELL_1, TRAINER_MITCHELL_2, TRAINER_MITCHELL_3, TRAINER_MITCHELL_4, TRAINER_MITCHELL_5, SOOTOPOLIS_CITY),
    [REMATCH_JACK] = REMATCH(TRAINER_JACK, TRAINER_JACK, TRAINER_JACK, TRAINER_JACK, TRAINER_JACK, EVER_GRANDE_CITY),
    [REMATCH_GREGORIUS] = REMATCH(TRAINER_GREGORIUS, TRAINER_GREGORIUS, TRAINER_GREGORIUS, TRAINER_GREGORIUS, TRAINER_GREGORIUS, EVER_GRANDE_CITY),
    [REMATCH_THANATOS] = REMATCH(TRAINER_THANATOS, TRAINER_THANATOS, TRAINER_THANATOS, TRAINER_THANATOS, TRAINER_THANATOS, EVER_GRANDE_CITY),
    [REMATCH_SHINJI] = REMATCH(TRAINER_SHINJI, TRAINER_SHINJI, TRAINER_SHINJI, TRAINER_SHINJI, TRAINER_SHINJI, EVER_GRANDE_CITY),
    [REMATCH_DARIO] = REMATCH(TRAINER_DARIO, TRAINER_DARIO, TRAINER_DARIO, TRAINER_DARIO, TRAINER_DARIO, EVER_GRANDE_CITY),
};
...
u8 GetTrainerBattleTransition(void)
{
    ...
    {
        if (gTrainerBattleOpponent_A == TRAINER_JACK)
            return B_TRANSITION_JACK;
        if (gTrainerBattleOpponent_A == TRAINER_GREGORIUS)
            return B_TRANSITION_GREGORIUS;
        if (gTrainerBattleOpponent_A == TRAINER_THANATOS)
            return B_TRANSITION_THANATOS;
        if (gTrainerBattleOpponent_A == TRAINER_SHINJI)
            return B_TRANSITION_SHINJI;
        return B_TRANSITION_CHAMPION;
    }
...
void SetUpTrainerEncounterMusic(void)
{
        ...
        && sTrainerBattleMode != TRAINER_BATTLE_CONTINUE_SCRIPT_DOUBLE_NO_MUSIC)
    {
        ...
        {
		case TRAINER_ENCOUNTER_MUSIC_KANTO_CHAMP:
            music = HG_SEQ_GS_VS_CHAMP;
            break;
		case TRAINER_ENCOUNTER_MUSIC_SINNOH_CHAMP:
            music = DP_SEQ_BA_CHANP;
            break;
		case TRAINER_ENCOUNTER_MUSIC_KANTO_CHAMP_2:
			MUS_RG_VS_CHAMPION;
			break;
