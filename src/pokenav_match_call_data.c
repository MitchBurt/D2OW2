...
static const match_call_text_data_t sRickTextScripts[] = {
    { MatchCall_Text_Rick1, FLAG_ENABLE_RICK_MATCH_CALL, 0xFFFF },
    { MatchCall_Text_Rick2, FLAG_DEFEATED_DEWFORD_GYM,     0xFFFF },
    { MatchCall_Text_Rick3, FLAG_DEFEATED_LAVARIDGE_GYM,   0xFFFF },
    { MatchCall_Text_Rick4, FLAG_DEFEATED_PETALBURG_GYM,   0xFFFF },
    { MatchCall_Text_Rick5, FLAG_RECEIVED_RED_OR_BLUE_ORB, 0xFFFF },
    { MatchCall_Text_Rick6, 0xFFFE,                        0xFFFF },
    { MatchCall_Text_Rick7, FLAG_SYS_GAME_CLEAR,           0xFFFF },
    { MatchCall_Text_Rick8, FLAG_SYS_GAME_CLEAR,           0xFFFF },
    { MatchCall_Text_Rick9, FLAG_SYS_GAME_CLEAR,           0xFFFF },
    { NULL,                   0xFFFF,                        0xFFFF }
};

static const struct MatchCallStructTrainer sRickMatchCallHeader =
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_PETALBURG_CITY,
    .flag = FLAG_ENABLE_RICK_MATCH_CALL,
    .rematchTableIdx = REMATCH_RICK,
    .desc = gText_RickMatchCallDesc,
    .name = gText_RickMatchCallName,
    .textData = sRickTextScripts
};
...
static const match_call_text_data_t sStevenTextScripts[] = {
    ...
    { MatchCall_Text_Steven6, FLAG_KRAKRUM_ESCAPED_SEAFLOOR_CAVERN, 0xFFFF },
...
static const match_call_text_data_t sMayTextScripts[] = {
    ...
    { MatchCall_Text_May10, FLAG_NOIRNET_AWAKENED_MAGMA_HIDEOUT, 0xFFFF },
    { MatchCall_Text_May11, FLAG_MET_TEAM_AQUA_HARBOR,           0xFFFF },
    { MatchCall_Text_May12, FLAG_TEAM_AQUA_ESCAPED_IN_SUBMARINE, 0xFFFF },
    { MatchCall_Text_May13, FLAG_KRAKRUM_ESCAPED_SEAFLOOR_CAVERN, 0xFFFF },
...
static const match_call_text_data_t sBrendanTextScripts[] = {
    ...
    { MatchCall_Text_Brendan10, FLAG_NOIRNET_AWAKENED_MAGMA_HIDEOUT, 0xFFFF },
    ...
    { MatchCall_Text_Brendan13, FLAG_KRAKRUM_ESCAPED_SEAFLOOR_CAVERN, 0xFFFF },
...
static const match_call_text_data_t sWallyTextScripts[] = {
    ...
    { MatchCall_Text_Wally5, FLAG_NOIRNET_AWAKENED_MAGMA_HIDEOUT, 0xFFFF },
    { MatchCall_Text_Wally6, FLAG_KRAKRUM_ESCAPED_SEAFLOOR_CAVERN, 0xFFFF },
...
const struct MatchCallLocationOverride sWallyLocationData[] = {
    ...
    { FLAG_NOIRNET_AWAKENED_MAGMA_HIDEOUT,    MAPSEC_NONE },
...
static const match_call_text_data_t sMasonTextScripts[] = {
    { MatchCall_Text_Mason1, 0xFFFE,              0xFFFF },
    { MatchCall_Text_Mason2, 0xFFFF,              0xFFFF },
    { MatchCall_Text_Mason3, 0xFFFF,              0xFFFF },
    { MatchCall_Text_Mason4, FLAG_SYS_GAME_CLEAR, 0xFFFF },
    { NULL,                    0xFFFF,              0xFFFF }
};

static const struct MatchCallStructTrainer sMasonMatchCallHeader =
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_RUSTBORO_CITY,
    .flag = FLAG_ENABLE_MASON_MATCH_CALL,
    .rematchTableIdx = REMATCH_MASON,
    .desc = gText_MasonMatchCallDesc,
    .name = NULL,
    .textData = sMasonTextScripts
};

static const match_call_text_data_t sZachTextScripts[] = {
    { MatchCall_Text_Zach1, 0xFFFE,              0xFFFF },
    { MatchCall_Text_Zach2, 0xFFFF,              0xFFFF },
    { MatchCall_Text_Zach3, 0xFFFF,              0xFFFF },
    { MatchCall_Text_Zach4, FLAG_SYS_GAME_CLEAR, 0xFFFF },
    { NULL,                   0xFFFF,              0xFFFF }
};

static const struct MatchCallStructTrainer sZachMatchCallHeader =
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_DEWFORD_TOWN,
    .flag = FLAG_ENABLE_ZACH_MATCH_CALL,
    .rematchTableIdx = REMATCH_ZACH,
    .desc = gText_ZachMatchCallDesc,
    .name = NULL,
    .textData = sZachTextScripts
};

static const match_call_text_data_t sTrevorTextScripts[] = {
    { MatchCall_Text_Trevor1, 0xFFFE,              0xFFFF },
    { MatchCall_Text_Trevor2, 0xFFFF,              0xFFFF },
    { MatchCall_Text_Trevor3, 0xFFFF,              0xFFFF },
    { MatchCall_Text_Trevor4, FLAG_SYS_GAME_CLEAR, 0xFFFF },
    { NULL,                    0xFFFF,              0xFFFF }
};

static const struct MatchCallStructTrainer sTrevorMatchCallHeader =
{
    .type = MC_TYPE_LEADER,
...
static const match_call_text_data_t sJaredTextScripts[] = {
    { MatchCall_Text_Jared1, 0xFFFE,              0xFFFF },
    { MatchCall_Text_Jared2, 0xFFFF,              0xFFFF },
    { MatchCall_Text_Jared3, 0xFFFF,              0xFFFF },
    { MatchCall_Text_Jared4, FLAG_SYS_GAME_CLEAR, 0xFFFF },
    { NULL,                     0xFFFF,              0xFFFF }
};

static const struct MatchCallStructTrainer sJaredMatchCallHeader =
{
    .type = MC_TYPE_LEADER,
...
static const match_call_text_data_t sTannerTextScripts[] = {
    { MatchCall_Text_Tanner1, 0xFFFE,              0xFFFF },
    { MatchCall_Text_Tanner2, 0xFFFF,              0xFFFF },
    { MatchCall_Text_Tanner3, 0xFFFF,              0xFFFF },
    { MatchCall_Text_Tanner4, FLAG_SYS_GAME_CLEAR, 0xFFFF },
    { NULL,                   0xFFFF,              0xFFFF }
};

static const struct MatchCallStructTrainer sTannerMatchCallHeader =
{
    .type = MC_TYPE_LEADER,
...
static const struct MatchCallStructTrainer sTateLizaMatchCallHeader =
{
    ...
    .flag = FLAG_ENABLE_TONY_AND_SAL_MATCH_CALL,
    .rematchTableIdx = REMATCH_TONY_AND_SAL,
    .desc = gText_TateLizaMatchCallDesc,
    .name = NULL,
    .textData = sTateLizaTextScripts
};

static const match_call_text_data_t sMitchellTextScripts[] = {
    { MatchCall_Text_Mitchell1, 0xFFFE,              0xFFFF },
    { MatchCall_Text_Mitchell2, 0xFFFF,              0xFFFF },
    { MatchCall_Text_Mitchell3, 0xFFFF,              0xFFFF },
    { MatchCall_Text_Mitchell4, FLAG_SYS_GAME_CLEAR, 0xFFFF },
    { NULL,                 0xFFFF,              0xFFFF }
};

static const struct MatchCallStructTrainer sMitchellMatchCallHeader =
{
    .type = MC_TYPE_LEADER,
...
static const match_call_text_data_t sGregoriusTextScripts[] = {
    { MatchCall_Text_Gregorius, 0xFFFF, 0xFFFF },
    { NULL,                  0xFFFF, 0xFFFF }
};

static const struct MatchCallStructTrainer sGregoriusMatchCallHeader =
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_EVER_GRANDE_CITY,
    .flag = FLAG_REMATCH_GREGORIUS,
    .rematchTableIdx = REMATCH_GREGORIUS,
    .desc = gText_EliteFourMatchCallDesc,
    .name = NULL,
...
static const match_call_text_data_t sDarioTextScripts[] = {
    { MatchCall_Text_Dario, 0xFFFF, 0xFFFF },
    { NULL,                   0xFFFF, 0xFFFF }
};

static const struct MatchCallStructTrainer sDarioMatchCallHeader =
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_EVER_GRANDE_CITY,
    .flag = FLAG_REMATCH_DARIO,
    .rematchTableIdx = REMATCH_DARIO,
    .desc = gText_ChampionMatchCallDesc,
    .name = NULL,
    .textData = sDarioTextScripts
};
...
static const match_call_t sMatchCallHeaders[] = {
    ...
    [MC_HEADER_RICK]     = {.leader = &sRickMatchCallHeader},
