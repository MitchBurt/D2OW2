...
static const u8 sText_PkmnGainedEXP[] = _("¡{B_BUFF1} ganó\n{B_BUFF3} puntos de Exp.{B_BUFF2}!\p");
...
static const u8 sText_PlayerLostAgainstEnemyTrainer[] = _("¡A {B_PLAYER_NAME} no le\nquedan Pokémon!\pPlayer perdió contra\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerPaidPrizeMoney[] = _("{B_PLAYER_NAME} pagó ¥{B_BUFF1} por\nperder…\p… … … …\p¡{B_PLAYER_NAME} está fuera\nde combate!{PAUSE_UNTIL_PRESS}");
...
static const u8 sText_PkmnWentToSleep[] = _("¡{B_ATK_NAME_WITH_PREFIX} se fué\na dormir!");
...
static const u8 sText_PkmnUnaffected[] = _("¡No afectó\na {B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_Trainer1SentOutPkmn2[] = _("¡{B_OPPONENT_MON1_NAME} es el Pokémon enviado\npor {B_TRAINER1_CLASS} {B_TRAINER1_NAME}!");
...
static const u8 sText_PkmnComeBack[] = _("¡Ya vale, {B_BUFF1}!\n¡Ven aquí!");
...
static const u8 sText_AutoHealHpUp[] = _("{B_ATK_NAME_WITH_PREFIX} healed a little bit!");
...
static const u8 sText_TeravoltEnters[] = _("¡{B_SCR_ACTIVE_NAME_WITH_PREFIX} desprende un aura\nchisporroteante!");
...
static const u8 sText_AnticipationActivates[] = _("¡{B_SCR_ACTIVE_NAME_WITH_PREFIX} se ha estremecido!");
static const u8 sText_ForewarnActivates[] = _("¡{B_SCR_ACTIVE_NAME_WITH_PREFIX} detectó el movimiento\n{B_BUFF1} de {B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_PlayerPaidPrizeMoney[] = _("{B_PLAYER_NAME} paid ¥{B_BUFF1} as the prize\nmoney…\p… … … …\pRun over!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerWhiteout[] = _("{B_PLAYER_NAME} is out of\nusable Pokémon!\p");
static const u8 sText_PlayerWhiteout2[] = _("{B_PLAYER_NAME} panicked and lost ¥{B_BUFF1}…\p… … … …\pRun over!!{PAUSE_UNTIL_PRESS}");
...
//static const u8 sText_MegaEvoEvolved[] = _("{B_ATK_NAME_WITH_PREFIX} has Mega\nEvolved into Mega {B_BUFF1}!");
static const u8 sText_MegaEvoEvolved[] = _("{B_ATK_NAME_WITH_PREFIX} has Mega\nEvolved!");
static const u8 sText_PkmnInvertedTypes[] = _("{B_ATK_NAME_WITH_PREFIX} Inverted\nthe type Effectiveness!");
static const u8 sText_ProtectiveVeilWasCreated[] = _("{B_ATK_NAME_WITH_PREFIX} Body\ncreated a Protective Veil!");
static const u8 sText_ProtectiveScreenWasCreated[] = _("{B_ATK_NAME_WITH_PREFIX} created\na Protective Screen!");
static const u8 sText_PkmnCutsSpDefenseWith[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\ncuts {B_DEF_NAME_WITH_PREFIX}'s Sp.Defense!");
static const u8 sText_StrangeForceDrowsy[] = _("An strange force made everybody\nDrowsy!");
...
static const u8 sText_ASandstormKickedUp[] = _("A sandstorm kicked up!");
static const u8 sText_PkmnsWillPerishIn3Turns[] = _("Both Pokémon will perish\nin three turns!");
static const u8 sText_AngerPointsPkmnRaisedAttack[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nraised its {B_BUFF1}!");
static const u8 sText_AbilityRaisedStatDrastically[] = _("{B_DEF_ABILITY} raised {B_DEF_NAME_WITH_PREFIX}'s\n{B_BUFF1} drastically!");
static const u8 sText_AsOneEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} has two Abilities!");
static const u8 sText_CuriousMedicineEnters[] = _("All the stat changes were reset\n thanks to {B_DEF_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}!");
static const u8 sText_CanActFaster[] = _("{B_ATK_NAME_WITH_PREFIX} can act faster,\nthanks to {B_LAST_ITEM}!");
static const u8 sText_MicleBerryActivates[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} boosted the accuracy of its\nnext move using {B_LAST_ITEM}!");
static const u8 sText_PkmnShookOffTheTaunt[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} shook off\nthe taunt!");
static const u8 sText_PkmnGotOverItsInfatuation[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} got over\nits infatuation!");
...
static const u8 sText_PkmnDidAmmountDamage[] = _("{B_ATK_NAME_WITH_PREFIX} did {B_BUFF3} Damage!{PAUSE 32}");
static const u8 sText_BattlerGotTheType[] = _("{B_ACTIVE_NAME_WITH_PREFIX} became a {B_BUFF1}-type!");
static const u8 sText_BattlerIsReadyToBite[] = _("{B_ACTIVE_NAME_WITH_PREFIX} is ready to bite!");
static const u8 sText_AttackerMoveRaisedStat[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_CURRENT_MOVE}\nraised its {B_BUFF1}!");
static const u8 sText_AttackerNullifiedAbilities[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nsurpressed everyone's ability!");
static const u8 sText_TargetPkmnHurtsWith[] = _("{B_ATK_NAME_WITH_PREFIX} attacked a second\ntime thanks to {B_ATK_ABILITY}!");
static const u8 sText_AttackerIsReadyToTestYou[] = _("The Legendary Pokemon {B_OPPONENT_MON1_NAME}\nis ready to test you.");
static const u8 sText_AllOfAttackerStatsRised[] = _("All of {B_OPPONENT_MON1_NAME}'s\nstats raised drastically!");
static const u8 sText_ThePokemonBlockedTheBall[] = _("{B_OPPONENT_MON1_NAME} blocked the Ball!");
static const u8 sText_TryWeakeningThePokemonFirst[] = _("Try Weakening {B_OPPONENT_MON1_NAME} a little more!");
static const u8 sText_WildLegendaryMegaEvolved[] = _("A mysterious force is surrounding the\nLegendary Pokemon {B_OPPONENT_MON1_NAME}!");
...
static const u8 sText_ShootingStarACtivated[] = _("{B_DEF_NAME_WITH_PREFIX} made a Wish!");
...
static const u8 sText_ItHurtIntoxicate[] = _("{B_ATK_NAME_WITH_PREFIX} is hurt\nby its drunk!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_SHOOTINGSTARTACTIVATED - 12] = sText_ShootingStarACtivated,
	[STRINGID_WILDLEGENDARYMEGAEVOLVED - 12] = sText_WildLegendaryMegaEvolved,
	[STRINGID_THEPOKEMONBLOCKEDTHEBALL - 12] = sText_ThePokemonBlockedTheBall,
	[STRINGID_TRYWEAKENINGITFIRST - 12] = sText_TryWeakeningThePokemonFirst,
	[STRINGID_ATTACKERISREADYTOTESTYOU - 12] = sText_AttackerIsReadyToTestYou,
	[STRINGID_ALLOFATTACKERSTATSRISED - 12] = sText_AllOfAttackerStatsRised,
	[STRINGID_ATTACKERSECONDHIT - 12] = sText_TargetPkmnHurtsWith,
	[STRINGID_ATTACKERNULLIFIEDABILITIES - 12] = sText_AttackerNullifiedAbilities,
	[STRINGID_ATTACKERMOVERAISEDSTAT - 12] = sText_AttackerMoveRaisedStat,
	[STRINGID_BATTLERISREADYTOBITE - 12] = sText_BattlerIsReadyToBite,
	[STRINGID_BATTLERABILITYRAISEDSTAT - 12] = sText_BattlerAbilityRaisedStat,
	[STRINGID_BATTLERGOTTHETYPE - 12] = sText_BattlerGotTheType,
	[STRINGID_BAGISFULL - 12] = gText_BoxIsFull2,
	...
	[STRINGID_ALL_PKMNGAINEDEXP - 12] = sText_PkmnAllGainedEXP,
	...
	[STRINGID_AUTOHEALHPUP - 12] = sText_AutoHealHpUp,
	[STRINGID_PKMNINVERTEDTYPES - 12] = sText_PkmnInvertedTypes,
	[STRINGID_PROTECTIVEVIELCREATED - 12] = sText_ProtectiveVeilWasCreated,
	[STRINGID_PROTECTIVESCREENCREATED - 12] = sText_ProtectiveScreenWasCreated,
	[STRINGID_PKMNCUTSDEFENSEWITH - 12] = sText_PkmnCutsSpDefenseWith,
	[STRINGID_DREAMWORLDMESSAGE - 12] = sText_StrangeForceDrowsy,
...
const u16 gSwitchInAbilityStringIds[] =
{
	...
	[MULTI_SWITCHIN_NEUTRALIZING_GAS] = STRINGID_ATTACKERNULLIFIEDABILITIES,
...
static const u8 *BattleStringGetOpponentNameByTrainerId(u16 trainerId, u8 *text, u8 multiplayerId, u8 battlerId)
{
    ...
    else
    {
        if(FlagGet(FLAG_PASSWORD_TRAINER)){
            ...
            toCpy = CompressedPlayerParty.trainerName;
        }
        else
...
static const u8 *BattleStringGetOpponentClassByTrainerId(u16 trainerId)
{
    ...
    if (gBattleTypeFlags & BATTLE_TYPE_SECRET_BASE)
        ...
        if(FlagGet(FLAG_PASSWORD_TRAINER)){
            struct CompressedPlayerParty CompressedPlayerParty = CreatePartyFromRamData();
            switch(CompressedPlayerParty.title){
                case PASSWORD_TRAINER_NEWBIE:
                case PASSWORD_TRAINER_NORMAL:
                    toCpy = gTrainerClassNames[TRAINER_CLASS_RS_PROTAG];
                break;
                case PASSWORD_TRAINER_CHAMPION:
                    toCpy = gTrainerClassNames[TRAINER_CLASS_CHAMPION];
                break;
                case PASSWORD_TRAINER_MASTER:
                    toCpy = gTrainerClassNames[TRAINER_CLASS_PKMN_MASTER];
                break;
                case PASSWORD_TRAINER_LEGEND:
                    toCpy = gTrainerClassNames[TRAINER_CLASS_PKMN_MASTER];
                break;
            }
        }
