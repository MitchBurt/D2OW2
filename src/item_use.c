...
void ItemUseOutOfBattle_Exiolite(u8 taskId)
{
    gItemUseCB = ItemUseCB_Exiolite;
    SetUpItemUseCallback(taskId);
}
...
void ItemUseOutOfBattle_IVWings(u8 taskId)
{
    gItemUseCB = ItemUseCB_IVWings;
    SetUpItemUseCallback(taskId);
}

void ItemUseOutOfBattle_TypeGem(u8 taskId)
{
    gItemUseCB = ItemUseCB_TypeGem;
    SetUpItemUseCallback(taskId);
}
