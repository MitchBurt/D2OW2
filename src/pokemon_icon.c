...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_CHEETORCH] = gMonIcon_Cheetorch,
    [SPECIES_SPICHEETAH] = gMonIcon_Spicheetah,
    ...
    [SPECIES_UNGGRUNT] = gMonIcon_Unggrunt,
    [SPECIES_SANGBLADE] = gMonIcon_Sangblade,
