...
static const u8 sRubyFacilityClassToEmerald[RS_FACILITY_CLASSES_COUNT - 2][2] =
{
    ...
    {RS_FACILITY_CLASS_ELITE_FOUR_M, FACILITY_CLASS_ELITE_FOUR_JACK},
    {RS_FACILITY_CLASS_ELITE_FOUR_F, FACILITY_CLASS_ELITE_FOUR_GREGORIUS},
    {RS_FACILITY_CLASS_LEADER_F, FACILITY_CLASS_LEADER_MASON},
    {RS_FACILITY_CLASS_LEADER_M, FACILITY_CLASS_LEADER_ZACH},
    {RS_FACILITY_CLASS_LEADER_MF, FACILITY_CLASS_LEADER_TONY_AND_SAL},
    ...
    {RS_FACILITY_CLASS_CHAMPION, FACILITY_CLASS_CHAMPION_DARIO},
...
static void FillTrainerParty(u16 trainerId, u8 firstMonId, u8 monCount)
{
    ...
    while (i != monCount)
    {
        ...
        CreateMonWithEVSpreadNatureOTID(&gEnemyParty[i + firstMonId],
                                             GetTrainerPokemon(gFacilityTrainerMons[monId].species, level),
                                             level,
		...
		if(gFacilityTrainerMons[monId].abilitynum < 3)
