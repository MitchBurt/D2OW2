...
const u8 gText_DexSearchColorYellow[] = _("Aseakusho");
...
const u8 gText_Dario[] = _("Dario");
const u8 gText_Steven[] = _("Mitchell");
const u8 gText_Zach[] = _("Zach");
const u8 gText_Tanner[] = _("Tanner");
const u8 gText_Gregorius[] = _("Gregorius");
const u8 gText_Thanatos[] = _("Thanatos");
...
const u8 gText_BerryalenDollAndPrice[] = _("Berryalen Doll 1,000 Coins");
const u8 gText_CookletDollAndPrice[] = _("Cooklet Doll 1,000 Coins");
const u8 gText_BaitordDollAndPrice[] = _("Baitord Doll   1,000 Coins");
...
const u8 gText_ParangeliaBerryPicking[] = _("Parangelia Berry-Picking");
...
const u8 gText_BurntonionDoll32BP[] = _("Burntonion Doll{CLEAR_TO 0x5E}32BP");
const u8 gText_FilmbrainDoll48BP[] = _("Filmbrain Doll{CLEAR_TO 0x5E}48BP");
const u8 gText_GarfelDoll48BP[] = _("Garfel Doll{CLEAR_TO 0x5E}48BP");
const u8 gText_EgoirlDoll48BP[] = _("Egoirl Doll{CLEAR_TO 0x5E}48BP");
const u8 gText_DittoDoll48BP[] = _("Ditto Doll{CLEAR_TO 0x5E}48BP");
const u8 gText_MegatronDoll80BP[] = _("Megatron Doll{CLEAR_TO 0x5E}80BP");
const u8 gText_TomDoll80BP[] = _("Tom Doll{CLEAR_TO 0x5E}80BP");
const u8 gText_KorbieDoll80BP[] = _("Korbie Doll{CLEAR_TO 0x5E}80BP");
const u8 gText_JebonyDoll128BP[] = _("Jebony Doll{CLEAR_TO 0x58}128BP");
const u8 gText_ShepeirdDoll128BP[] = _("Shepeird Doll{CLEAR_TO 0x58}128BP");
const u8 gText_YggdraconDoll256BP[] = _("Yggdracon Doll{CLEAR_TO 0x58}256BP");
const u8 gText_SkorpyrosDoll256BP[] = _("Skorpyros Doll{CLEAR_TO 0x58}256BP");
const u8 gText_SperiathonDoll256BP[] = _("Speriathon Doll{CLEAR_TO 0x58}256BP");
...
const u8 gText_BerryPickingRecords[] = _("Parangelia Berry-Picking records");
...
const u8 gText_MasonMatchCallDesc[] = _("Dura Maestra");
const u8 gText_ZachMatchCallDesc[] = _("El Luchador");
const u8 gText_TrevorMatchCallDesc[] = _("Alto Voltaje");
const u8 gText_JaredMatchCallDesc[] = _("Pura Pasión");
const u8 gText_TannerMatchCallDesc[] = _("Poder Etéreo");
const u8 gText_TateLizaMatchCallDesc[] = _("Dúo Místico");
const u8 gText_MitchellMatchCallDesc[] = _("Conquistador");
...
const u8 gText_MainMenuSoundTest[] = _("Sound Test");
...
const u8 gText_UpdatingSaveExternalData[] = _("Updating save file using external\ndata. Please wait."); // Unused
const u8 gText_SaveFileUpdated[] = _("The save file has been erased\ndue to hacking and lack of train."); // Unused
...
const u8 gJPText_No1MSubCircuit[] = _("The 1M sub-board is not plugged in!\n Please use a supported Emulator");
...
const u8 gText_SpAtk3[] = _("Sp. Atk");
const u8 gText_SpDef3[] = _("Sp. Def");
const u8 gText_WontHaveEffectNuzlocke[] = _("It won't have any effect.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_CallRegisteredTrainer[] = _("Open the Dexnav.");
...
const u8 gText_ButtonMode[] = _("Title Screen");
...
const u8 gText_TransitionStyleNormal[] = _("Normal");
const u8 gText_TransitionStyleInstant[] = _("Instant");
const u8 gText_UnitSystemMetric[] = _("Normal");
const u8 gText_UnitSystemImperial[] = _("Custom");
...
const u8 gText_Options_AcroBike[] = _("Acro");
const u8 gText_Options_MachBike[] = _("Mach");
const u8 gText_NumPlayerLink[] = _("{STR_VAR_1}P Link");
const u8 gText_BronzeCard[] = _("Bronze");
const u8 gText_CopperCard[] = _("Copper");
const u8 gText_SilverCard[] = _("Silver");
...
const u8 gText_RickMatchCallDesc[] = _("Reliable one");
const u8 gText_MomMatchCallDesc[] = _("Calm & kind");
const u8 gText_WallyMatchCallDesc[] = _("{PKMN} lover");
const u8 gText_RickMatchCallName[] = _("Dad");
const u8 gText_MomMatchCallName[] = _("Mom");
const u8 gText_ScottMatchCallDesc[] = _("Elusive eyes");
const u8 gText_ScottMatchCallName[] = _("Scott");
const u8 gText_MasonMatchCallDesc[] = _("Rockin' whiz");
const u8 gText_ZachMatchCallDesc[] = _("The big hit");
const u8 gText_TrevorMatchCallDesc[] = _("Swell shock");
const u8 gText_JaredMatchCallDesc[] = _("Passion burn");
const u8 gText_TannerMatchCallDesc[] = _("Sky tamer");
const u8 gText_TateLizaMatchCallDesc[] = _("Mystic duo");
const u8 gText_MitchellMatchCallDesc[] = _("Dandy charm");
...
const u8 gText_EVO_LEVEL_SILCOON[]                  = _("LvlUp to {STR_VAR_2}, Nyankitty persona");
const u8 gText_EVO_LEVEL_CASCOON[]                  = _("LvlUp to {STR_VAR_2}, Mechduck persona");
...
//Music Expansion
const u8 gText_Region_BGM[]   = _("BGM Music");
const u8 gText_Region_Kanto[] = _("Kanto");
const u8 gText_Region_Jotho[] = _("Johto");
const u8 gText_Region_Hoenn[] = _("Hoenn");
const u8 gText_Region_Sinnoh[] = _("Sinnoh");
...
const u8 gText_Difficulty_PC_Storage[] = _("PC Storage");
const u8 gText_Difficulty_Password[] = _("Password");

const u8 gText_Companion_Trainer_Password[] = _("Get your Trainer Password");
...
const u8 gText_Game_Modes_No_Evo[] 	   = _("No Evolution Mode");
const u8 gText_Game_Modes_Leveless[]   = _("Leveless Mode");
const u8 gText_Game_Modes_Vanilla[]    = _("Vanilla Mode");
const u8 gText_Game_Modes_No_Split[]   = _("No Split Mode");
const u8 gText_Game_Modes_No_Mega[]    = _("No Mega Mode");
const u8 gText_Game_Modes_Default[]    = _("Set Default Options");
const u8 gText_Game_Modes_Save[]       = _("Save");
const u8 gText_Game_Modes_More[]       = _("More Modes");

const u8 gText_Relearn_Move[]       = _("Relearn a Move");
const u8 gText_Egg_Tutor[]          = _("Tutor an Egg Move");
const u8 gText_Move_Tutor[]          = _("Tutor a Move");
const u8 gText_TM_Tutor[]           = _("Teach a TM Move");
...
const u8 gText_Costume_Emerald[]  		= _("Emerald Costume");
const u8 gText_Costume_RubySapphire[] 	= _("RS Costume");
const u8 gText_Costume_FRLG[]    		= _("FRLG Costume");
const u8 gText_Costume_BW[]    		    = _("BW Costume");


const u8 gText_Pokedex_Ability0[]       = _("First Ability");
const u8 gText_Pokedex_Ability1[]       = _("Second Ability");
const u8 gText_Pokedex_Ability2[]       = _("Hidden Ability");

const u8 gText_Game_Modes_Randomized_Enable[]     		= _("Randomized Mode");
const u8 gText_Game_Modes_Randomized_Full_Enable[]      = _("Random Party Mode");

const u8 gText_Default[]    	= _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Normal   ");
const u8 gText_ColorRed[] 		= _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Red      ");
const u8 gText_CapColorBlue[]   = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Blue     ");
const u8 gText_ColorYellow[] 	= _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Yellow   ");
const u8 gText_ColorGreen[] 	= _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Green    ");
const u8 gText_ColorBlack[] 	= _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Black    ");
const u8 gText_ColorBrown[] 	= _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Brown    ");
const u8 gText_ColorPurple[] 	= _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Purple   ");
const u8 gText_ColorGray[] 		= _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Gray     ");
