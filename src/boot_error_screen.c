...
static const u8 sText_BootError_8[] = _("NOGBA: Emulator not supported");
static const u8 sText_BootError_9[] = _("VBA: Emulator not supported");

static const u8 sText_PipelineFail_1[] = _("This Emulator is not supported!");
static const u8 sText_PipelineFail_2[] = _("The game can still be played, but");
static const u8 sText_PipelineFail_3[] = _("it will crash a lot.");
static const u8 sText_PipelineFail_4[] = _("Failed Test(s):");

static const u8 sText_Readme[] = _("Check the {COLOR BLUE}{SHADOW LIGHT_BLUE}Readme{COLOR DARK_GREY}{SHADOW LIGHT_GREY} for more information.");
static const u8 sText_MyBoy[] = _("{COLOR RED}{SHADOW LIGHT_RED}MyBoy! users can dismiss this message{COLOR DARK_GREY}{SHADOW LIGHT_GREY}");
static const u8 sText_PressAnyKeyToContinue[] = _("Press the {COLOR BLUE}{SHADOW LIGHT_BLUE}Select{COLOR DARK_GREY}{SHADOW LIGHT_GREY} Button to continue.");
...
static void Task_BootErrorScreen_Step(u8 taskId)
{
    ...
    case 180:
		AddTextPrinterParameterized3(
            0,
            2,
            GetStringXpos(sText_Readme, TEXT_CENTER),
            10 * 8 + TX_MARG_TOP,
		...
		AddTextPrinterParameterized3(
            0,
            2,
            GetStringXpos(sText_MyBoy, TEXT_CENTER),
            12 * 8 + TX_MARG_TOP,
            sTextColors[FMS_COLOR_GREY],
            TEXT_SPEED_FF,
            sText_MyBoy
