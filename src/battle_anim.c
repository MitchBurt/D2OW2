...
const struct CompressedSpriteSheet gBattleAnimPicTable[] =
{
    ...
    {gBattleAnimSpriteGfx_PurpleShinji, 0x800, ANIM_TAG_DRAGON_ASCENT},
    ...
    {gBattleAnimSpriteGfx_PurpleShinji, 0x800, ANIM_TAG_DRAGON_ASCENT_FOE},
    ...
    {gBattleAnimSpriteGfx_PurpleShinji, 0x800, ANIM_TAG_PURPLE_SHINJI},
...
const struct CompressedSpritePalette gBattleAnimPaletteTable[] =
{
    ...
    {gBattleAnimSpritePal_GreenShinji,	ANIM_TAG_DRAGON_ASCENT},
    ...
    {gBattleAnimSpritePal_PurpleShinji, ANIM_TAG_PURPLE_SHINJI},
