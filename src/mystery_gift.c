...
struct MysteryGiftMonStructure gMysteryGiftMons[] =
{
	...
	[CARD_GNORB] =
    {
		...
		.nature				= NATURE_TIMID,
		.pokeball 			= ITEM_CHERISH_BALL,
		.moves				= {MOVE_STUN_SPORE, MOVE_BITE, MOVE_LIGHT_SCREEN, MOVE_DISARMING_VOICE},
		.isShiny 			= TRUE,
		.ivs 				= {31, 31, 31, 31, 31, 31},
		.evs 				= {0, 0, 0, 0, 0, 0},
		.exioliteBoost 		= FALSE,
	...
	[CARD_CTHEYE] =
    {
		...
		.nature				= NATURE_TIMID,
		.pokeball 			= ITEM_CHERISH_BALL,
		.moves				= {MOVE_BITE, MOVE_AERIAL_ACE, MOVE_DOUBLE_TEAM, MOVE_NIGHT_SLASH},
		.isShiny 			= TRUE,
		.ivs 				= {31, 31, 31, 31, 31, 31},
		.evs 				= {0, 0, 0, 0, 0, 0},
		.exioliteBoost 		= FALSE,
	...
	[CARD_FROSLING] =
    {
		...
		.pokeball 			= ITEM_CHERISH_BALL,
		.moves				= {MOVE_ICE_FANG, MOVE_DRAGON_RAGE, MOVE_DRAGON_DANCE, MOVE_BITE},
		.isShiny 			= TRUE,
		.ivs 				= {31, 31, 31, 31, 31, 31},
		.evs 				= {0, 0, 0, 0, 0, 0},
		.exioliteBoost 		= TRUE,
	...
	[CARD_SKORCHI] =
    {
		...
		.nature				= NATURE_TIMID,
		.pokeball 			= ITEM_CHERISH_BALL,
		.moves				= {MOVE_BUG_BITE, MOVE_FIRE_FANG, MOVE_DIG, MOVE_STRUGGLE_BUG},
		.isShiny 			= TRUE,
		.ivs 				= {31, 31, 31, 31, 31, 31},
		.evs 				= {0, 0, 0, 0, 0, 0},
		.exioliteBoost 		= FALSE,
	...
	[CARD_MEADOSAUR] =
    {
		...
		.nature				= NATURE_TIMID,
		.pokeball 			= ITEM_CHERISH_BALL,
		.moves				= {MOVE_VINE_WHIP, MOVE_DIG, MOVE_DRAGON_TAIL, MOVE_DRAGON_DANCE},
		.isShiny 			= TRUE,
		.ivs 				= {31, 31, 31, 31, 31, 31},
		.evs 				= {0, 0, 0, 0, 0, 0},
		.exioliteBoost 		= FALSE,
	...
	[CARD_COOKLET] =
    {
		...
		.pokeball 			= ITEM_CHERISH_BALL,
		.moves				= {MOVE_EMBER, MOVE_TACKLE, MOVE_PLAY_ROUGH, MOVE_FAKE_OUT},
		.isShiny 			= TRUE,
		.ivs 				= {31, 31, 31, 31, 31, 31},
		.evs 				= {0, 0, 0, 0, 0, 0},
		.exioliteBoost 		= FALSE,
	...
	[CARD_BERRYALEN] =
    {
		...
		.nature				= NATURE_JOLLY,
		.pokeball 			= ITEM_CHERISH_BALL,
		.moves				= {MOVE_SCRATCH, MOVE_LUNGE, MOVE_SEED_FORCE, MOVE_ELECTRO_BALL},
		.isShiny 			= TRUE,
		.ivs 				= {31, 31, 31, 31, 31, 31},
		.evs 				= {0, 0, 0, 0, 0, 0},
		.exioliteBoost 		= FALSE,
