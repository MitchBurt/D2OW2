...
static const union AnimCmd sSpriteAnim_TypeFood[] = {
    ANIMCMD_FRAME(TYPE_FOOD * 8, 0, FALSE, FALSE),
    ANIMCMD_END
};
...
static const union AnimCmd sSpriteAnim_StatusIntox[] = {
    ANIMCMD_FRAME(28, 0, FALSE, FALSE),
    ANIMCMD_END
};
