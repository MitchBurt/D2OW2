...
static const union AnimCmd sAnim_BANANA_1[] =
{
    ANIMCMD_FRAME(1, 30),
    ANIMCMD_FRAME(0, 30),
    ANIMCMD_FRAME(0, 1),
...
static const union AnimCmd sAnim_SQUIGGRO_1[] =
{
    ANIMCMD_FRAME(0, 30),
    ANIMCMD_FRAME(1, 30),
    ANIMCMD_FRAME(0, 1),
...
static const union AnimCmd *const sAnims_BANANA[] ={
    sAnim_GeneralFrame0,
    sAnim_BANANA_1,
};
...
static const union AnimCmd *const sAnims_SQUIGGRO[] ={
    sAnim_GeneralFrame0,
    sAnim_SQUIGGRO_1,
};
