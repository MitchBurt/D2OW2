const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(BERRORD_MEGA, gMonPalette_BerrordMega),
    SPECIES_PAL(FAZEAGLE_MEGA, gMonPalette_FazeagleMega),
    SPECIES_PAL(KUKLOPS_MEGA, gMonPalette_KuklopsMega),
    SPECIES_PAL(SHEMUE_MEGA, gMonPalette_ShemueMega),
    SPECIES_PAL(SANS_MEGA, gMonPalette_SansMega),
    SPECIES_PAL(TROLOLO_MEGA, gMonPalette_TrololoMega),
    SPECIES_PAL(ITRIMID_MEGA, gMonPalette_ItrimidMega),
    SPECIES_PAL(KROLLER_MEGA, gMonPalette_KrollerMega),
    SPECIES_PAL(USARMY_MEGA, gMonPalette_UsarmyMega),
    SPECIES_PAL(GOD_MEGA_X, gMonPalette_GodMegaX),
    SPECIES_PAL(GOD_MEGA_Y, gMonPalette_GodMegaY),
    SPECIES_PAL(BACID_MEGA, gMonPalette_BacidMega),
    SPECIES_PAL(HOLOCAST_MEGA, gMonPalette_HolocastMega),
    SPECIES_PAL(NUGGIE_MEGA, gMonPalette_NuggieMega),
    SPECIES_PAL(HAPPYMAUL_MEGA, gMonPalette_HappymaulMega),
    ...
    SPECIES_PAL(THATSFURRY_MEGA, gMonPalette_ThatsfurryMega),
