const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(MINIMAL, gMonPalette_Minimal),
    ...
    SPECIES_PAL(MINIMAL_MEGA, gMonPalette_MinimalMega),
    SPECIES_PAL(FROSILISK_MEGA, gMonPalette_FrosiliskMega),
    ...
    SPECIES_PAL(UNJOY_MEGA, gMonPalette_AudinoMega),
