const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(MYRESEFT, gMonPalette_Myreseft),
    ...
    SPECIES_PAL(KUKLUX, gMonPalette_Abra),
    ...
    SPECIES_PAL(SHAPOOPYZ, gMonPaletteShapoopyz),
    ...
    SPECIES_PAL(MR_MIME, gMonPalette_Alieon),
    ...
    SPECIES_PAL(NYANKAT, gMonPalette_Nyankat),
    ...
    SPECIES_PAL(WORMADAM-T, gMonPalette_Wormadam-T),
    SPECIES_PAL(ROCCO, gMonPalette_Rocco),
    SPECIES_PAL(ABOMINATION, gMonPalette_Abomination),
    ...
    SPECIES_PAL(OUROBOUTLET, gMonPalette_Ouroboutlet),
    SPECIES_PAL(PICHU, gMonPalette_Pichu),
    SPECIES_PAL(POOPRAT, gMonPalette_Pooprat),
    SPECIES_PAL(VCR-BRAIN, gMonPalette_VCR-Brain),
    ...
    SPECIES_PAL(AURICLIARY2, gMonPalette_Auricliary2),
    ...
    SPECIES_PAL(AURICLIARY_Z, gMonPalette_AuricliaryZ),
    ...
    SPECIES_PAL(PYUKURIMESLANCHU, gMonPalette_Pyukurimeslanchu),
    ...
    SPECIES_PAL(ETERPUCKIDS, gMonPalette_Eterpuckids),
    ...
    SPECIES_PAL(NONONMON_ALOLAN, gMonPalette_NononmonAlolan),
    ...
    SPECIES_PAL(RIMESLANCH_ALOLAN, gMonPalette_RimeslanchAlolan),
    ...
    SPECIES_PAL(MR_MIME_GALARIAN, gMonPalette_AlieonGalarian),
...
SPECIES_PAL(CRAMORANT_GULPING, gMonPalette_CramorantGulping),
    ...
    SPECIES_PAL(ETERPUCKIDS_ETERNAMAX, gMonPalette_Eterpuckids/*Eternamax*/),
