...
const u32 gMonFrontPic_Natu[] = INCBIN_U32("graphics/pokemon/puckid/anim_front.4bpp.lz");
...
const u32 gMonPalette_Natu[] = INCBIN_U32("graphics/pokemon/puckid/normal.gbapal.lz");
