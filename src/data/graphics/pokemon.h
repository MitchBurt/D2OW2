...
const u32 gMonFrontPic_Qwilfish_Husian[] 		= INCBIN_U32("graphics/pokemon/qwilfish/husian/anim_front.4bpp.lz");
const u32 gMonPalette_Qwilfish_Husian[] 		= INCBIN_U32("graphics/pokemon/qwilfish/husian/normal.gbapal.lz");
const u32 gMonBackPic_Qwilfish_Husian[] 		= INCBIN_U32("graphics/pokemon/qwilfish/husian/back.4bpp.lz");
const u32 gMonShinyPalette_Qwilfish_Husian[] 	= INCBIN_U32("graphics/pokemon/qwilfish/husian/shiny.gbapal.lz");
const u8 gMonIcon_Qwilfish_Husian[] 			= INCBIN_U8 ("graphics/pokemon/qwilfish/husian/icon.4bpp");
//const u8 gMonFootprint_Qwilfish_Husian[] 		= INCBIN_U8 ("graphics/pokemon/qwilfish/husian/footprint.1bpp");