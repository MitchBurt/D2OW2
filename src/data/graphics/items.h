...
const u32 gItemIcon_Endmysuffizer[] = INCBIN_U32("graphics/items/icons/endmysuffizer.4bpp.lz");
const u32 gItemIconPalette_Endmysuffizer[] = INCBIN_U32("graphics/items/icon_palettes/endmysuffizer.gbapal.lz");
