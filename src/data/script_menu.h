...
static const struct MenuAction MultichoiceList_WheresTowermasta[] =
{
    {gText_CaveOfOrigin},
    {gText_MtPyre},
    {gText_SkyPillar},
...
static const struct MenuAction MultichoiceList_Mock_Battle_Level[] =
{
    {gText_Difficulty_Easy},
    {gText_Difficulty_Normal},
    {gText_Difficulty_Hard},
...
static const struct MenuAction MultichoiceList_Companion_Stuff[] =
{
    {gText_Companion_Trainer_Password},
    {gText_Exit},
};
...
static const struct MenuAction MultichoiceList_Game_Modes[] =
{
	...
	{gText_Game_Modes_More},
	{gText_Game_Modes_Save},
};

static const struct MenuAction MultichoiceList_Game_Modes_2[] =
{
	{gText_Game_Modes_Double},
    {gText_Game_Modes_No_Evo},
	{gText_Game_Modes_Leveless},
	{gText_Game_Modes_No_Split},
	{gText_Game_Modes_Vanilla},
	{gText_Game_Modes_More},
    //{gText_Game_Modes_No_Mega_Evolutions},
	//{gText_Game_Modes_No_Experience},
	//{gText_Game_Modes_No_Catching},
	//{gText_Game_Modes_Save},
};
...
static const struct MenuAction MultichoiceList_Game_Modes_Enable_Randomized[] =
{
	{gText_Game_Modes_Randomized_Enable},
	{gText_Game_Modes_Randomized_Full_Enable},
	{gText_Cancel2},
};
...
static const struct MenuAction MultichoiceList_Teach_Moves[] =
{
	{gText_Relearn_Move},
    {gText_Egg_Tutor},
	{gText_Move_Tutor},
...
static const struct MenuAction MultichoiceList_Costumes[] =
{
	{gText_Costume_Emerald},
    {gText_Costume_RubySapphire},
	{gText_Costume_FRLG},
	{gText_Costume_BW},
	{gText_Cancel2},
};
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_WHERES_TOWERMASTA]            = MULTICHOICE(MultichoiceList_WheresTowermasta),
	...
	[MULTI_GAME_MODES_2]         	   = MULTICHOICE(MultichoiceList_Game_Modes_2),
	...
	[MULTI_TEACH_MOVES]                = MULTICHOICE(MultichoiceList_Teach_Moves),
	[MULTI_COSTUMES]                   = MULTICHOICE(MultichoiceList_Costumes),
	[MULTI_RANDOMIZED_MODE]            = MULTICHOICE(MultichoiceList_Game_Modes_Enable_Randomized),
	[MULTI_NEW_GAME_PLUS_QUESTIONS]    = MULTICHOICE(MultichoiceList_New_Game_Plus_Questions),
	[MULTI_MOCK_BATTLE_OPTIONS]        = MULTICHOICE(MultichoiceList_Mock_Battle_Level),
	[MULTI_COMPANION_OPTIONS]          = MULTICHOICE(MultichoiceList_Companion_Stuff),
};
