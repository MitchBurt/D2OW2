...
static const union AnimCmd *const sAnims_EliteFourJack[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_EliteFourGregorius[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_LeaderMason[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_LeaderZach[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_LeaderRick[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_LeaderTonyAndSal[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_ChampionDario[] ={
    sAnim_GeneralFrame0,
};
...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_LEADER_RICK] = sAnims_LeaderRick,
    [TRAINER_PIC_LEADER_TANNER] = sAnims_LeaderTanner,
    [TRAINER_PIC_LEADER_TONY_AND_SAL] = sAnims_LeaderTonyAndSal,
    ...
    [TRAINER_PIC_CHAMPION_DARIO] = sAnims_ChampionDario,
	...
	[TRAINER_PIC_CRUSH_KIN] = sAnims_RubySapphireMay,
	[TRAINER_PIC_NURSE] = sAnims_RubySapphireMay,
	[TRAINER_PIC_HILBERT] = sAnims_RubySapphireMay,
};
