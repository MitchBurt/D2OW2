const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_GOOFSHRUMOL_LADY] = {.size = 8, .y_offset = 1},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(GOOFSHRUMOL_LADY, gTrainerFrontPic_GoofshrumolLady, 0x800),
...
const struct SpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(GOOFSHRUMOL_LADY, gTrainerPalette_GoofshrumolLady),
