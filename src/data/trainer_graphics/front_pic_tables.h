const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_ELITE_FOUR_JACK] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_ELITE_FOUR_GREGORIUS] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_ELITE_FOUR_THANATOS] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_ELITE_FOUR_SHINJI] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_MASON] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_ZACH] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_TREVOR] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_JARED] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_RICK] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_TANNER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_TONY_AND_SAL] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_MITCHELL] = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_CHAMPION_DARIO] = {.size = 8, .y_offset = 2},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(ELITE_FOUR_JACK, gTrainerFrontPic_EliteFourJack, 0x800),
    TRAINER_SPRITE(ELITE_FOUR_GREGORIUS, gTrainerFrontPic_EliteFourGregorius, 0x800),
    TRAINER_SPRITE(ELITE_FOUR_THANATOS, gTrainerFrontPic_EliteFourThanatos, 0x800),
    TRAINER_SPRITE(ELITE_FOUR_SHINJI, gTrainerFrontPic_EliteFourShinji, 0x800),
    TRAINER_SPRITE(LEADER_MASON, gTrainerFrontPic_LeaderMason, 0x800),
    TRAINER_SPRITE(LEADER_ZACH, gTrainerFrontPic_LeaderZach, 0x800),
    TRAINER_SPRITE(LEADER_TREVOR, gTrainerFrontPic_LeaderTrevor, 0x800),
    TRAINER_SPRITE(LEADER_JARED, gTrainerFrontPic_LeaderJared, 0x800),
    TRAINER_SPRITE(LEADER_RICK, gTrainerFrontPic_LeaderRick, 0x800),
    TRAINER_SPRITE(LEADER_TANNER, gTrainerFrontPic_LeaderTanner, 0x800),
    TRAINER_SPRITE(LEADER_TONY_AND_SAL, gTrainerFrontPic_LeaderTonyAndSal, 0x800),
    TRAINER_SPRITE(LEADER_MITCHELL, gTrainerFrontPic_LeaderMitchell, 0x800),
    ...
    TRAINER_SPRITE(CHAMPION_DARIO, gTrainerFrontPic_ChampionDario, 0x1000),
	...
	TRAINER_SPRITE(NURSE, gTrainerFrontPic_BlueNurse, 0x800),
	TRAINER_SPRITE(HILBERT, gTrainerFrontPic_Hilbert, 0x800),
};
...
const struct SpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(ELITE_FOUR_JACK, gTrainerPalette_EliteFourJack),
    TRAINER_PAL(ELITE_FOUR_GREGORIUS, gTrainerPalette_EliteFourGregorius),
    TRAINER_PAL(ELITE_FOUR_THANATOS, gTrainerPalette_EliteFourThanatos),
    TRAINER_PAL(ELITE_FOUR_SHINJI, gTrainerPalette_EliteFourShinji),
    TRAINER_PAL(LEADER_MASON, gTrainerPalette_LeaderMason),
    TRAINER_PAL(LEADER_ZACH, gTrainerPalette_LeaderZach),
    TRAINER_PAL(LEADER_TREVOR, gTrainerPalette_LeaderTrevor),
    TRAINER_PAL(LEADER_JARED, gTrainerPalette_LeaderJared),
    TRAINER_PAL(LEADER_RICK, gTrainerPalette_LeaderRick),
    TRAINER_PAL(LEADER_TANNER, gTrainerPalette_LeaderTanner),
    TRAINER_PAL(LEADER_TONY_AND_SAL, gTrainerPalette_LeaderTonyAndSal),
    TRAINER_PAL(LEADER_MITCHELL, gTrainerPalette_LeaderMitchell),
    ...
    TRAINER_PAL(CHAMPION_DARIO, gTrainerPalette_ChampionDario),
	...
	TRAINER_PAL(NURSE, gTrainerPalette_BlueNurse),
