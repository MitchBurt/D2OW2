...
{
    SLATEPORT_TENT_MON_YOLKANNER_1,
    SLATEPORT_TENT_MON_QUACKSHOT_1,
    SLATEPORT_TENT_MON_HEROKKU,
    SLATEPORT_TENT_MON_YOLKANNER_2,
    SLATEPORT_TENT_MON_ANGBEAST,
    SLATEPORT_TENT_MON_COOPID,
    SLATEPORT_TENT_MON_GANESH,
    SLATEPORT_TENT_MON_KECLEON_2,
    SLATEPORT_TENT_MON_BLINKY_1,
    SLATEPORT_TENT_MON_BLINKY_2,
    SLATEPORT_TENT_MON_DOUBLINKER,
    -1
};
...
{
    SLATEPORT_TENT_MON_YOLKANNER_1,
    SLATEPORT_TENT_MON_TONCRETE,
    SLATEPORT_TENT_MON_DREIDRILL,
    SLATEPORT_TENT_MON_YOLKANNER_2,
    SLATEPORT_TENT_MON_VULPOINTER_1,
    SLATEPORT_TENT_MON_DOODOOBOB,
    SLATEPORT_TENT_MON_GANESH,
    SLATEPORT_TENT_MON_BLINKY_1,
    SLATEPORT_TENT_MON_VULPOINTER_2,
    SLATEPORT_TENT_MON_METIORE_2,
    SLATEPORT_TENT_MON_SMOSLIME,
    -1
};

const u16 gSlateportBattleTentTrainerMons_Kelsie[] = 
{
    SLATEPORT_TENT_MON_SHRIMPOT_1,
    SLATEPORT_TENT_MON_SHRIMPOT_2,
    SLATEPORT_TENT_MON_SEAKUSH_1,
    SLATEPORT_TENT_MON_SCUBITE,
    SLATEPORT_TENT_MON_TAILLOW,
    SLATEPORT_TENT_MON_COWERLIN,
    SLATEPORT_TENT_MON_ANGBEAST,
    SLATEPORT_TENT_MON_COOPID,
    SLATEPORT_TENT_MON_KECLEON_1,
    SLATEPORT_TENT_MON_BATCARDI_2,
    SLATEPORT_TENT_MON_SMOSLIME,
    -1
};
...
const u16 gSlateportBattleTentTrainerMons_Davon[] = 
{
    ...
    SLATEPORT_TENT_MON_SHRIMPOT_2,
    SLATEPORT_TENT_MON_SEAKUSH_1,
    SLATEPORT_TENT_MON_SOBBLEAF,
    SLATEPORT_TENT_MON_METIORE_1,
    SLATEPORT_TENT_MON_VULPOINTER_1,
    SLATEPORT_TENT_MON_COOPID,
    SLATEPORT_TENT_MON_FLOOTEY,
    SLATEPORT_TENT_MON_NUSHAKE,
    SLATEPORT_TENT_MON_KECLEON_2,
    SLATEPORT_TENT_MON_BLINKY_2,
    SLATEPORT_TENT_MON_NOCTRUM_2,
    -1
};

const u16 gSlateportBattleTentTrainerMons_Glenda[] = 
{
    SLATEPORT_TENT_MON_MEOWRRIOR_1,
    SLATEPORT_TENT_MON_MEOWRRIOR_2,
    SLATEPORT_TENT_MON_DREIDRILL,
    SLATEPORT_TENT_MON_FURRLEAD_1,
    SLATEPORT_TENT_MON_FURRLEAD_2,
    SLATEPORT_TENT_MON_CORDRA_1,
    SLATEPORT_TENT_MON_AWMANE,
    SLATEPORT_TENT_MON_DESQUARED,
    SLATEPORT_TENT_MON_GANESH,
    SLATEPORT_TENT_MON_KUKLAN,
    SLATEPORT_TENT_MON_PURRSOUR_1,
    SLATEPORT_TENT_MON_PURRSOUR_2,
    SLATEPORT_TENT_MON_CORDRA_2,
    -1
};
...
const u16 gSlateportBattleTentTrainerMons_Helena[] = 
{
    SLATEPORT_TENT_MON_FURRLEAD_1,
    SLATEPORT_TENT_MON_FURRLEAD_2,
    SLATEPORT_TENT_MON_CIGHTED,
    SLATEPORT_TENT_MON_FLOOTEY,
    SLATEPORT_TENT_MON_DOODOOBOB,
    SLATEPORT_TENT_MON_ARACKNE_1,
    SLATEPORT_TENT_MON_GANESH,
    SLATEPORT_TENT_MON_SEAKUSH_2,
    SLATEPORT_TENT_MON_ARACKNE_2,
    SLATEPORT_TENT_MON_CARNIGORE,
    SLATEPORT_TENT_MON_DOUBLINKER,
    -1
};
...
const u16 gSlateportBattleTentTrainerMons_Rodolfo[] = 
{
    ...
    SLATEPORT_TENT_MON_SHRIMPOT_1,
    SLATEPORT_TENT_MON_SHRIMPOT_2,
    SLATEPORT_TENT_MON_BATCARDI_1,
    SLATEPORT_TENT_MON_NOCTRUM_1,
    SLATEPORT_TENT_MON_FURRLEAD_1,
    SLATEPORT_TENT_MON_ZEPPUR,
    SLATEPORT_TENT_MON_CIGHTED,
    SLATEPORT_TENT_MON_COOPID,
    SLATEPORT_TENT_MON_FLOOTEY,
    SLATEPORT_TENT_MON_NUSHAKE,
    SLATEPORT_TENT_MON_SORTAFURRY,
    -1
};
...
const u16 gSlateportBattleTentTrainerMons_Davion[] = 
{
    ...
    SLATEPORT_TENT_MON_KECLEON_2,
    SLATEPORT_TENT_MON_METIORE_2,
    SLATEPORT_TENT_MON_JAFEET,
    SLATEPORT_TENT_MON_FURBOIS,
    -1
};
...
const u16 gSlateportBattleTentTrainerMons_Kendall[] = 
{
    ...
    SLATEPORT_TENT_MON_BLINKY_1,
    SLATEPORT_TENT_MON_BLINKY_2,
    SLATEPORT_TENT_MON_QUACKSHOT_2,
    SLATEPORT_TENT_MON_DOUBLINKER,
    -1
};
...
{
    SLATEPORT_TENT_MON_MEOWRRIOR_1,
    SLATEPORT_TENT_MON_NYANTIGER,
    SLATEPORT_TENT_MON_SOBBLEAF,
    SLATEPORT_TENT_MON_CORDRA_1,
    SLATEPORT_TENT_MON_TAILLOW,
    SLATEPORT_TENT_MON_ANIVENOM_1,
    SLATEPORT_TENT_MON_ANGBEAST,
    SLATEPORT_TENT_MON_FLOOTEY,
    SLATEPORT_TENT_MON_KECLEON_1,
    SLATEPORT_TENT_MON_KECLEON_2,
    SLATEPORT_TENT_MON_NOTAFURRY,
    SLATEPORT_TENT_MON_JAFEET,
    -1
};
...
const u16 gSlateportBattleTentTrainerMons_Irvin[] = 
{
    ...
    SLATEPORT_TENT_MON_COWERLIN,
    SLATEPORT_TENT_MON_DOODOOBOB,
    SLATEPORT_TENT_MON_REWINDLE,
    SLATEPORT_TENT_MON_DNDICE,
    -1
};
...
const u16 gSlateportBattleTentTrainerMons_Kyler[] = 
{
    ...
    SLATEPORT_TENT_MON_COWERLIN,
    SLATEPORT_TENT_MON_DOODOOBOB,
    SLATEPORT_TENT_MON_ANIVENOM_2,
    SLATEPORT_TENT_MON_PURRSOUR_1,
    SLATEPORT_TENT_MON_PURRSOUR_2,
    SLATEPORT_TENT_MON_ARMYDRONE,
    -1
};
...
const struct BattleFrontierTrainer gSlateportBattleTentTrainers[NUM_BATTLE_TENT_TRAINERS] = 
{
    ...
    [SLATEPORT_TENT_TRAINER_RODOLFO] = {
        ...
        .speechBefore = {EC_WORD_GO, EC_WORD_GET, EC_WORD_A, EC_POKEMON(SPLASHICOOT), EC_WORD_FOR, EC_WORD_ME},
        .speechWin = {EC_WORD_AWW, EC_WORD_YOU, EC_WORD_DON_T, EC_WORD_HAVE, EC_WORD_A, EC_POKEMON(SPLASHICOOT)},
        .speechLose = {EC_WORD_PLEASE, EC_WORD_I, EC_WORD_NEED, EC_WORD_A, EC_POKEMON(SPLASHICOOT), EC_WORD_BADLY},
    ...
    [SLATEPORT_TENT_TRAINER_MAGGIE] = {
        ...
        .speechBefore = {EC_POKEMON(SAUCIE), EC_POKEMON(GOALEM), EC_POKEMON2(LEAVE), EC_WORD_ELLIPSIS, EC_WORD_UM, EC_WORD_ELLIPSIS},
        .speechWin = {EC_POKEMON(SCATRUSH), EC_WORD_ELLIPSIS, EC_WORD_UM, EC_POKEMON(ARACKNE), EC_WORD_EXCL, -1},
        .speechLose = {EC_POKEMON(SCATRUSH), EC_WORD_ELLIPSIS, EC_WORD_UM, EC_POKEMON2(SHEPEIRD), EC_WORD_ELLIPSIS, EC_WORD_UH_OH},
...
{
    VERDANTURF_TENT_MON_BLINKY,
    VERDANTURF_TENT_MON_CARNIGORE,
    VERDANTURF_TENT_MON_DREIDRILL,
    VERDANTURF_TENT_MON_SCUBITE,
    VERDANTURF_TENT_MON_HEROKKU,
    -1
};
...
const u16 gVerdanturfBattleTentTrainerMons_Dilan[] = 
{
    ...
    VERDANTURF_TENT_MON_METIORE,
    VERDANTURF_TENT_MON_DREIDRILL,
    VERDANTURF_TENT_MON_GANESH,
    VERDANTURF_TENT_MON_FURBOIS,
    -1
};
...
const u16 gVerdanturfBattleTentTrainerMons_Eliana[] = 
{
    ...
    VERDANTURF_TENT_MON_COOPID,
    VERDANTURF_TENT_MON_CIGHTED_1,
    VERDANTURF_TENT_MON_SCUBITE,
    VERDANTURF_TENT_MON_SHRIMPOT,
    -1
};
...
const u16 gVerdanturfBattleTentTrainerMons_Markus[] = 
{
    ...
    VERDANTURF_TENT_MON_COOPID,
    VERDANTURF_TENT_MON_SCUBITE,
    VERDANTURF_TENT_MON_CIGHTED_2,
    VERDANTURF_TENT_MON_FLOOTEY,
    -1
};

const u16 gVerdanturfBattleTentTrainerMons_Caitlyn[] = 
{
    VERDANTURF_TENT_MON_DUPLICAT,
    VERDANTURF_TENT_MON_KECLEON,
    VERDANTURF_TENT_MON_CORDRA,
    VERDANTURF_TENT_MON_FURRLEAD,
    VERDANTURF_TENT_MON_LEGEARTH,
    VERDANTURF_TENT_MON_YOLKANNER,
    -1
};

const u16 gVerdanturfBattleTentTrainerMons_Desiree[] = 
{
    VERDANTURF_TENT_MON_BATCARDI,
    VERDANTURF_TENT_MON_KECLEON,
    VERDANTURF_TENT_MON_ARACKNE,
    VERDANTURF_TENT_MON_LEGEARTH,
...
{
    VERDANTURF_TENT_MON_MEOWRRIOR,
    VERDANTURF_TENT_MON_ZEPPUR,
    VERDANTURF_TENT_MON_XAPP,
    VERDANTURF_TENT_MON_CORDRA,
    VERDANTURF_TENT_MON_AWMANE,
    -1
};
...
const u16 gVerdanturfBattleTentTrainerMons_Ashten[] = 
{
    ...
    VERDANTURF_TENT_MON_METIORE,
    VERDANTURF_TENT_MON_COWERLIN,
    -1
};

const u16 gVerdanturfBattleTentTrainerMons_Gerard[] = 
{
    VERDANTURF_TENT_MON_SEAKUSH,
    VERDANTURF_TENT_MON_COOPID,
    VERDANTURF_TENT_MON_NOCTRUM,
    VERDANTURF_TENT_MON_NUSHAKE,
    VERDANTURF_TENT_MON_SHRIMPOT,
    -1
};
...
const u16 gVerdanturfBattleTentTrainerMons_Bradly[] = 
{
    ...
    VERDANTURF_TENT_MON_DUPLICAT,
    VERDANTURF_TENT_MON_DUCKERTRON,
    VERDANTURF_TENT_MON_CIGHTED_1,
    -1
};
...
const u16 gVerdanturfBattleTentTrainerMons_Prestin[] = 
{
    ...
    VERDANTURF_TENT_MON_YOLKANNER,
    VERDANTURF_TENT_MON_COWERLIN,
    VERDANTURF_TENT_MON_DNDICE,
    -1
};

const u16 gVerdanturfBattleTentTrainerMons_Ernesto[] = 
{
    VERDANTURF_TENT_MON_DESQUARED,
    VERDANTURF_TENT_MON_AWMANE,
    VERDANTURF_TENT_MON_CORDRA,
    VERDANTURF_TENT_MON_BRAVOGOR,
    VERDANTURF_TENT_MON_NOCTRUM,
    -1
};
...
const u16 gVerdanturfBattleTentTrainerMons_Waren[] = 
{
    VERDANTURF_TENT_MON_DUPLICAT,
    VERDANTURF_TENT_MON_ARON_1,
    VERDANTURF_TENT_MON_VULPOINTER_1,
    VERDANTURF_TENT_MON_CARNIGORE,
    VERDANTURF_TENT_MON_XAPP,
    -1
};
...
{
    FALLARBOR_TENT_MON_CARNIGORE,
    FALLARBOR_TENT_MON_BLINKY,
    FALLARBOR_TENT_MON_SORTAFURRY,
    FALLARBOR_TENT_MON_QUACKSHOT,
    FALLARBOR_TENT_MON_HEROKKU,
    FALLARBOR_TENT_MON_YOLKANNER,
    -1
};

const u16 gFallarborBattleTentTrainerMons_Javier[] = 
{
    FALLARBOR_TENT_MON_GANESH,
    FALLARBOR_TENT_MON_METIORE,
    FALLARBOR_TENT_MON_DREIDRILL,
    FALLARBOR_TENT_MON_TONCRETE,
    FALLARBOR_TENT_MON_JAFEET,
    FALLARBOR_TENT_MON_YOLKANNER,
    -1
};
...
{
    FALLARBOR_TENT_MON_NUSHAKE,
    FALLARBOR_TENT_MON_NOCTRUM,
    FALLARBOR_TENT_MON_COOPID,
    FALLARBOR_TENT_MON_SEAKUSH,
...
{
    FALLARBOR_TENT_MON_BATCARDI,
    FALLARBOR_TENT_MON_NOCTRUM,
    FALLARBOR_TENT_MON_COOPID,
    FALLARBOR_TENT_MON_SEAKUSH,
    FALLARBOR_TENT_MON_CIGHTED_1,
    -1
};

const u16 gFallarborBattleTentTrainerMons_Arianna[] = 
{
    FALLARBOR_TENT_MON_CORDRA,
    FALLARBOR_TENT_MON_ZEPPUR_2,
    FALLARBOR_TENT_MON_FURRLEAD,
...
{
    FALLARBOR_TENT_MON_VULPOINTER,
    FALLARBOR_TENT_MON_BRAVOGOR,
    FALLARBOR_TENT_MON_FURRLEAD,
    FALLARBOR_TENT_MON_ANIVENOM,
    FALLARBOR_TENT_MON_SEAKUSH,
    FALLARBOR_TENT_MON_CARNIGORE,
...
{
    FALLARBOR_TENT_MON_ZEPPUR_1,
    FALLARBOR_TENT_MON_PURRSOUR,
    FALLARBOR_TENT_MON_DUPLICAT,
    FALLARBOR_TENT_MON_NUSHAKE,
...
{
    FALLARBOR_TENT_MON_NINCADA,
    FALLARBOR_TENT_MON_NYANTIGER,
    FALLARBOR_TENT_MON_DUCKERTRON,
    FALLARBOR_TENT_MON_DNDICE,
    FALLARBOR_TENT_MON_REWINDLE,
...
{
    FALLARBOR_TENT_MON_CORDRA,
    FALLARBOR_TENT_MON_DESQUARED,
    FALLARBOR_TENT_MON_AWMANE,
    FALLARBOR_TENT_MON_COWERLIN,
    FALLARBOR_TENT_MON_BRAVOGOR,
    -1
};
