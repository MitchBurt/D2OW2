...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_BICYELION, SPECIES_PARANGELIA, SPECIES_MURPHIRE, SPECIES_DEATHCUBED, SPECIES_LONGIFER, SPECIES_XENOTOPS, SPECIES_HAPPYMAUL, SPECIES_TEMP, SPECIES_GIGALPHA, SPECIES_FURRLEAD},
        .id = 5,
    ...
    },
    {
        ...
        .species = {SPECIES_ABSOL, SPECIES_CROBAT, SPECIES_GIGALPHA, SPECIES_DEATHCUBED, SPECIES_SHARKEG, SPECIES_AUXILISK, SPECIES_HAZETHOTH, SPECIES_ENDERMON, SPECIES_TEMP, SPECIES_BIPHARMA},
        .id = 12,
