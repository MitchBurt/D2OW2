...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_XAPP, SPECIES_CARNIGORE, SPECIES_MCCHICKY, SPECIES_AUXILISK, SPECIES_HELLAPHANT, SPECIES_GANGBEATS, SPECIES_FURRLEAD, SPECIES_QUACKNATOR, SPECIES_NONONMON, SPECIES_WHISCASH},
        .id = 1,
    ...
    },
    {
        ...
        .species = {SPECIES_LEGEARTH, SPECIES_LOSSILITH, SPECIES_GOURMASTER, SPECIES_ERRORINE, SPECIES_COFFICRAB, SPECIES_MUK, SPECIES_DRUNKABUS, SPECIES_TROPIUS, SPECIES_SOLROCK, SPECIES_YEESAUR},
        .id = 9,
    ...
    },
    {
        ...
        .species = {SPECIES_MONGELORD, SPECIES_BICYELION, SPECIES_PERRIPUS, SPECIES_FREDDIFER, SPECIES_SYSTANIC, SPECIES_THAUMNAR, SPECIES_ELECHAIR, SPECIES_WAILORD, SPECIES_SHARPEDO, SPECIES_DISMALO},
        .id = 10,
    ...
    },
    {
        ...
        .species = {SPECIES_AREALGUN, SPECIES_BICYELION, SPECIES_NOCTRUM, SPECIES_NONONMON, SPECIES_WAILORD, SPECIES_KROLLER, SPECIES_BAITANK, SPECIES_OUROBOLET, SPECIES_WHISCASH, SPECIES_MCCHICKY},
        .id = 11,
    ...
    },
    {
        ...
        .species = {SPECIES_ABSOL, SPECIES_CROBAT, SPECIES_GIGALPHA, SPECIES_DEATHCUBED, SPECIES_SHARPEDO, SPECIES_AUXILISK, SPECIES_HAZETHOTH, SPECIES_ENDERMON, SPECIES_NOSEPASS, SPECIES_BIPHARMA},
        .id = 12,
    ...
    },
    {
        ...
        .species = {SPECIES_INCREDALEN, SPECIES_TOYUTA, SPECIES_GALADRAKE, SPECIES_HEBURROW, SPECIES_XENOTOPS, SPECIES_CROBAT, SPECIES_CRADILY, SPECIES_SOLROCK, SPECIES_LUNATONE, SPECIES_LOSSILITH},
        .id = 14,
