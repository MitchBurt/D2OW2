...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_SAWSBAWS, SPECIES_KUKLOPS, SPECIES_SCEPTILE, SPECIES_SALAMENCE, SPECIES_PERRIPUS, SPECIES_MAWILE, SPECIES_WEEZING, SPECIES_LANTURN, SPECIES_GARDEVOIR, SPECIES_MILOTIC},
        .id = 7,
    ...
    },
    {
        ...
        .species = {SPECIES_ABSOL, SPECIES_CROBAT, SPECIES_EXPLOUD, SPECIES_DEATHCUBED, SPECIES_SHARPEDO, SPECIES_MANECTRIC, SPECIES_METAGROSS, SPECIES_ENDERMON, SPECIES_NOSEPASS, SPECIES_WEEZING},
        .id = 12,
