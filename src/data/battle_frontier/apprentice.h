...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_XAPP, SPECIES_CARNIGORE, SPECIES_MCCHICKY, SPECIES_MANECTRIC, SPECIES_TORKOAL, SPECIES_GANGBEATS, SPECIES_FURRLEAD, SPECIES_LUDICOLO, SPECIES_CRAWDAUNT, SPECIES_WHISCASH},
        .id = 1,
    ...
    },
    {
        ...
        .species = {SPECIES_CARNIGORE, SPECIES_GOALEM, SPECIES_ALTARIA, SPECIES_PERRIPUS, SPECIES_FLYGON, SPECIES_KUKLOPS, SPECIES_THATSFURRY, SPECIES_WAILORD, SPECIES_SELTCLAW, SPECIES_FURRLEAD},
        .id = 3,
