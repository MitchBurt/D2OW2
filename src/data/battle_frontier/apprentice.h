...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_XAPP, SPECIES_CARNIGORE, SPECIES_MCCHICKY, SPECIES_MANECTRIC, SPECIES_TORKOAL, SPECIES_GANGBEATS, SPECIES_FURRLEAD, SPECIES_QUACKNATOR, SPECIES_CRAWDAUNT, SPECIES_WHISCASH},
        .id = 1,
    ...
    },
    {
        ...
        .species = {SPECIES_INCREDALEN, SPECIES_GANJAZE, SPECIES_SEAWEE, SPECIES_ROSELIA, SPECIES_SETRONIC, SPECIES_FLYGON, SPECIES_BRELOOM, SPECIES_MILOTIC, SPECIES_UNSC, SPECIES_CRADILY},
        .id = 8,
