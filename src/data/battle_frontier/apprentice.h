...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_AREALGUN, SPECIES_BICYELION, SPECIES_PELIPPER, SPECIES_CRAWDAUNT, SPECIES_WAILORD, SPECIES_KROLLER, SPECIES_SWAMPERT, SPECIES_OUROBOLET, SPECIES_WHISCASH, SPECIES_SHUCKLE},
        .id = 11,
