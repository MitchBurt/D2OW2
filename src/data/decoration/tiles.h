...
const u16 DecorGfx_SKIPPA_DOLL[] = {
    OBJ_EVENT_GFX_SKIPPA_DOLL
};

const u16 DecorGfx_SEAKUSH_DOLL[] = {
    OBJ_EVENT_GFX_SEAKUSH_DOLL
};

const u16 DecorGfx_FILMBRAIN_DOLL[] = {
    OBJ_EVENT_GFX_FILMBRAIN_DOLL
};
...
const u16 DecorGfx_BURNTONION_DOLL[] = {
    OBJ_EVENT_GFX_BURNTONION_DOLL
};

const u16 DecorGfx_BERRYALEN_DOLL[] = {
    OBJ_EVENT_GFX_BERRYALEN_DOLL
};

const u16 DecorGfx_COOKLET_DOLL[] = {
    OBJ_EVENT_GFX_COOKLET_DOLL
};

const u16 DecorGfx_BAITORD_DOLL[] = {
    OBJ_EVENT_GFX_BAITORD_DOLL
};

const u16 DecorGfx_RATMAN_DOLL[] = {
    OBJ_EVENT_GFX_RATMAN_DOLL
};

const u16 DecorGfx_BABINION_DOLL[] = {
    OBJ_EVENT_GFX_BABINION_DOLL
};

const u16 DecorGfx_DREIDRILL_DOLL[] = {
    OBJ_EVENT_GFX_DREIDRILL_DOLL
};
...
const u16 DecorGfx_SMOSLIME_DOLL[] = {
    OBJ_EVENT_GFX_SMOSLIME_DOLL
};

const u16 DecorGfx_ARMYDRONE_DOLL[] = {
    OBJ_EVENT_GFX_ARMYDRONE_DOLL
};

const u16 DecorGfx_SYMBITE_DOLL[] = {
    OBJ_EVENT_GFX_SYMBITE_DOLL
};

const u16 DecorGfx_SCUBITE_DOLL[] = {
    OBJ_EVENT_GFX_SCUBITE_DOLL
};

const u16 DecorGfx_SOBBLEAF_DOLL[] = {
    OBJ_EVENT_GFX_SOBBLEAF_DOLL
};
...
const u16 DecorGfx_YEESAUR_DOLL[] = {
    OBJ_EVENT_GFX_BIG_YEESAUR_DOLL
};

const u16 DecorGfx_JEBONY_DOLL[] = {
    OBJ_EVENT_GFX_BIG_JEBONY_DOLL
};

const u16 DecorGfx_YGGDRACON_DOLL[] = {
    OBJ_EVENT_GFX_BIG_YGGDRACON_DOLL
};

const u16 DecorGfx_SKORPYROS_DOLL[] = {
    OBJ_EVENT_GFX_BIG_SKORPYROS_DOLL
};

const u16 DecorGfx_SPERIATHON_DOLL[] = {
...
const u16 DecorGfx_BEERIO_DOLL[] = {
    OBJ_EVENT_GFX_BIG_BEERIO_DOLL
};
...
const u16 DecorGfx_NAWFFLE_DOLL[] = {
    OBJ_EVENT_GFX_BIG_NAWFFLE_DOLL
};
