...
const u8 DecorDesc_SEAKUSH_DOLL[] = _(
    "Muñeco de Seakush.\n"
        "Ponlo en una\n"
        "mesa o tapete.");

const u8 DecorDesc_FILMBRAIN_DOLL[] = _(
    "Muñeco de Filmbrain.\n"
        "Ponlo en una\n"
        "mesa o tapete.");
...
const u8 DecorDesc_BERRYALEN_DOLL[] = _(
    "Muñeco de\n"
        "Berryalen. Ponlo en\n"
        "una mesa o tapete.");

const u8 DecorDesc_COOKLET_DOLL[] = _(
    "Muñeco de\n"
        "Cooklet. Ponlo en\n"
        "una mesa o tapete.");

const u8 DecorDesc_BAITORD_DOLL[] = _(
    "Muñeco de Baitord.\n"
        "Ponlo en una mesa\n"
        "o tapete.");

const u8 DecorDesc_RATMAN_DOLL[] = _(
    "Muñeco de Ratman.\n"
        "Ponlo en una mesa\n"
        "o tapete.");
...
const u8 DecorDesc_ARMYDRONE_DOLL[] = _(
    "Muñeco de Armydrone.\n"
        "Ponlo en una mesa\n"
        "o tapete.");

const u8 DecorDesc_SYMBITE_DOLL[] = _(
    "Muñeco de Symbite.\n"
        "Ponlo en una mesa\n"
        "o tapete.");

const u8 DecorDesc_SCUBITE_DOLL[] = _(
    "Muñeco de Scubite.\n"
        "Ponlo en una mesa\n"
        "o tapete.");

const u8 DecorDesc_SOBBLEAF_DOLL[] = _(
    "Muñeco de Sobbleaf.\n"
        "Ponlo en una mesa\n"
        "o tapete.");
...
const u8 DecorDesc_SHRIMPOT_DOLL[] = _(
    "Muñeco grande.\n"
        "Ponlo en una mesa\n"
        "o tapete.");
