const u32 *const gDecorIconTable[][2] = 
{
    ...
    [DECOR_SKIPPA_DOLL]    = {NULL, NULL},
    [DECOR_SEAKUSH_DOLL]     = {NULL, NULL},
    [DECOR_FILMBRAIN_DOLL]     = {NULL, NULL},
    [DECOR_MEGATRON_DOLL]  = {NULL, NULL},
    [DECOR_TOM_DOLL]  = {NULL, NULL},
    [DECOR_KORBIE_DOLL]   = {NULL, NULL},
    [DECOR_SNEDDIT_DOLL] = {NULL, NULL},
    [DECOR_GARFEL_DOLL]     = {NULL, NULL},
    [DECOR_EGOIRL_DOLL]   = {NULL, NULL},
    [DECOR_DITTO_DOLL]      = {NULL, NULL},
    [DECOR_BURNTONION_DOLL]   = {NULL, NULL},
    [DECOR_BERRYALEN_DOLL]    = {NULL, NULL},
    [DECOR_COOKLET_DOLL]    = {NULL, NULL},
    [DECOR_BAITORD_DOLL]     = {NULL, NULL},
    [DECOR_RATMAN_DOLL]    = {NULL, NULL},
    [DECOR_BABINION_DOLL]     = {NULL, NULL},
    [DECOR_DREIDRILL_DOLL]     = {NULL, NULL},
    [DECOR_KECLEON_DOLL]    = {NULL, NULL},
    [DECOR_AZURILL_DOLL]    = {NULL, NULL},
    [DECOR_SMOSLIME_DOLL]     = {NULL, NULL},
    [DECOR_ARMYDRONE_DOLL]     = {NULL, NULL},
    [DECOR_SYMBITE_DOLL]     = {NULL, NULL},
    [DECOR_SCUBITE_DOLL]      = {NULL, NULL},
    [DECOR_SOBBLEAF_DOLL]     = {NULL, NULL},
    ...
    [DECOR_SHEPEIRD_DOLL]    = {gDecorIcon_ShepeirdDoll, gDecorIconPalette_ShepeirdDoll},
    [DECOR_YEESAUR_DOLL]     = {gDecorIcon_YeesaurDoll, gDecorIconPalette_YeesaurDoll},
    [DECOR_JEBONY_DOLL]     = {gDecorIcon_JebonyDoll, gDecorIconPalette_JebonyDoll},
    [DECOR_YGGDRACON_DOLL]   = {gDecorIcon_YggdraconDoll, gDecorIconPalette_YggdraconDoll},
    [DECOR_SKORPYROS_DOLL]  = {gDecorIcon_SkorpyrosDoll, gDecorIconPalette_SkorpyrosDoll},
    [DECOR_SPERIATHON_DOLL]  = {gDecorIcon_SperiathonDoll, gDecorIconPalette_SperiathonDoll},
    [DECOR_SHRIMPOT_DOLL]    = {gDecorIcon_ShrimpotDoll, gDecorIconPalette_ShrimpotDoll},
    [DECOR_BEERIO_DOLL]   = {gDecorIcon_BeerioDoll, gDecorIconPalette_BeerioDoll},
    [DECOR_REGICE_DOLL]     = {gDecorIcon_RegiceDoll, gDecorIconPalette_RegiceDoll},
    [DECOR_NAWFFLE_DOLL]  = {gDecorIcon_NawffleDoll, gDecorIconPalette_NawffleDoll}
};
