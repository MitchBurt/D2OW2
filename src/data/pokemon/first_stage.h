...
/* 	[SPECIES_FIROME]	        = {SPECIES_FIROME}, //TODO
    ...
    [SPECIES_SKIPPA]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_DISHEATS},
    ...
    [SPECIES_HAZMATE]              = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_EBOLABLE}},
    [SPECIES_UNGA]             = {{EVO_LEVEL, 16, SPECIES_BUNGA}},
    [SPECIES_BUNGA]              = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_OOGABOOGA}},
    [SPECIES_EGOIRL]              = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_GOTHOT}},
    [SPECIES_SAUCIE]                = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_SAWSBAWS}},
    [SPECIES_SNEDDIT]            = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_COSMIE}},
    ...
    [SPECIES_SMOGAS]                 = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_GANJAZE},
    ...
    [SPECIES_CTHEYE]             = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_OPTICULU}},
    ...
    [SPECIES_FURBOIS]	            = {{EVO_TRADE, 0, SPECIES_LONGIFER}},
    ...
    [SPECIES_TONCRETE]	            = {{EVO_TRADE, 0, SPECIES_LOSSILITH}},
    ...
    [SPECIES_DEATHCUBED]	            = {{EVO_MAPSEC, MAPSEC_NEW_MAUVILLE, SPECIES_MAGNEZONE}},
    ...
    [SPECIES_COOLAR]              = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_FRIDEGE}},
    [SPECIES_SKELEDOOT]	            = {{EVO_LEVEL, 25, SPECIES_BEEGMIKE}},
    [SPECIES_BEEGMIKE]	            = {{EVO_TRADE, 0, SPECIES_SANS}},
    ...
    [SPECIES_BILLOMINAT]	            = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_CIPHRON},
    ...
    [SPECIES_CAPFALCO]	            = {{EVO_MOVE, MOVE_ROLLOUT, SPECIES_LICKILICKY}},
    [SPECIES_FENNAF]	            = {{EVO_LEVEL_DAY, 35, SPECIES_BIPHARMA},
									   {EVO_LEVEL_NIGHT, 35, SPECIES_BIPHARMA_GALARIAN}},
    ...
    [SPECIES_BANANACE]	            = {{EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_TANGROWTH}},
    ...
    [SPECIES_BURIK]                = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_BICYELION}},
    [SPECIES_CHUXKUSH]               = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_NUGGIE}},
    [SPECIES_KRAFPUNK]            = {{EVO_TRADE_ITEM, ITEM_ELECTIRIZER, SPECIES_ELECTIVIRE}},
    [SPECIES_ENDMYSUFF]	            = {{EVO_TRADE_ITEM, ITEM_MAGMARIZER, SPECIES_MAGMORTAR}},
    ...
    [SPECIES_PORYGON]	            = {{EVO_TRADE_ITEM, ITEM_UP_GRADE, SPECIES_CRABERAVE}},
    ...
    [SPECIES_ABOMINATON]	            = {{EVO_LEVEL, 18, SPECIES_WURM}},
    ...
    [SPECIES_CHARLES]	                = {{EVO_MOVE, MOVE_DOUBLE_HIT, SPECIES_AMBIPOM}},
    [SPECIES_MELARICK]               = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_WRECKFAST}},
    [SPECIES_SHARCRUSH]	                = {{EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_YANMEGA}},
    [SPECIES_MEGALADETH]	            = {{EVO_LEVEL, 20, SPECIES_AREALGUN}},
    [SPECIES_GAHBLIN]	            = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_HONCHKROW}},
    [SPECIES_LILREAPER]            = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_MISMAGIUS}},
    [SPECIES_ANTINDER]	            = {{EVO_LEVEL, 31, SPECIES_WAILE}},
    [SPECIES_SHAWT]	            = {{EVO_ITEM_HOLD_NIGHT, ITEM_RAZOR_FANG, SPECIES_GLISCOR}},
    ...
    [SPECIES_PINATI]	            = {{EVO_ITEM_HOLD_NIGHT, ITEM_RAZOR_CLAW, SPECIES_WEAVILE}},
    ...
    [SPECIES_SCRAPCHAT]	            = {{EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_MAMOSWINE}},
    ...
    [SPECIES_CRABERAVE]	            = {{EVO_TRADE_ITEM, ITEM_DUBIOUS_DISC, SPECIES_PORYGON_Z}},
