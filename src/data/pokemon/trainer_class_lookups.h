const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_ELITE_FOUR_JACK] = TRAINER_PIC_ELITE_FOUR_JACK,
    [FACILITY_CLASS_ELITE_FOUR_GREGORIUS] = TRAINER_PIC_ELITE_FOUR_GREGORIUS,
    [FACILITY_CLASS_LEADER_MASON] = TRAINER_PIC_LEADER_MASON,
    [FACILITY_CLASS_LEADER_ZACH] = TRAINER_PIC_LEADER_ZACH,
    [FACILITY_CLASS_LEADER_TONY_AND_SAL] = TRAINER_PIC_LEADER_TONY_AND_SAL,
    ...
    [FACILITY_CLASS_CHAMPION_DARIO] = TRAINER_PIC_CHAMPION_DARIO,
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_ELITE_FOUR_JACK] = TRAINER_CLASS_ELITE_FOUR,
    [FACILITY_CLASS_ELITE_FOUR_GREGORIUS] = TRAINER_CLASS_ELITE_FOUR,
    [FACILITY_CLASS_LEADER_MASON] = TRAINER_CLASS_LEADER,
    [FACILITY_CLASS_LEADER_ZACH] = TRAINER_CLASS_LEADER,
    [FACILITY_CLASS_LEADER_TONY_AND_SAL] = TRAINER_CLASS_LEADER,
    ...
    [FACILITY_CLASS_CHAMPION_DARIO] = TRAINER_CLASS_CHAMPION,
