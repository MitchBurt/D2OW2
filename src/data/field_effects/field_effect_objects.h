...
const struct SpritePalette gSpritePalette_SurfBlob = {gObjectEventPalette_SurfBlob, OBJ_EVENT_PAL_SURF_BLOB};
...
static const struct SpriteFrameImage sPicTable_SurfBlob[] = {
    overworld_frame(gFieldEffectObjectPic_SurfBlob, 2, 8, 0),
    overworld_frame(gFieldEffectObjectPic_SurfBlob, 2, 8, 1),
    overworld_frame(gFieldEffectObjectPic_SurfBlob, 2, 8, 2),
    overworld_frame(gFieldEffectObjectPic_SurfBlob, 2, 8, 3),
    overworld_frame(gFieldEffectObjectPic_SurfBlob, 2, 8, 4),
    overworld_frame(gFieldEffectObjectPic_SurfBlob, 2, 8, 5),
};
...
const struct SpriteTemplate gFieldEffectObjectTemplate_SurfBlob = {
    .tileTag = 0xFFFF,
    .paletteTag = OBJ_EVENT_PAL_SURF_BLOB,
...
static const union AnimCmd sAnim_Towermasta[] = {
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd *const sAnimTable_Towermasta[] = {
    sAnim_Towermasta,
};

const struct SpriteFrameImage  sPicTable_Towermasta[] = {
    overworld_frame(gObjectEventPic_Pokemon_Species_384, 4, 4, 0),
};

const struct SpriteTemplate gFieldEffectObjectTemplate_Towermasta = {
    .tileTag = 0xFFFF,
    .paletteTag = 0xFFFF,
    .oam = &gObjectEventBaseOam_32x32,
    .anims = sAnimTable_Towermasta,
    .images = sPicTable_Towermasta,
    .affineAnims = gDummySpriteAffineAnimTable,
    .callback = UpdateTowermastaSpotlightEffect,
};
