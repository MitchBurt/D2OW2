...
u16 GetMapRandomPokemon(u16 TrainerClass, u16 species)
{
	...
	{SPECIES_NONE,SPECIES_NONE,SPECIES_NONE,SPECIES_NONE,SPECIES_NONE,SPECIES_NONE,
	 SPECIES_NONE,SPECIES_NONE,SPECIES_NONE,SPECIES_NONE,SPECIES_NONE,SPECIES_NONE, SPECIES_NONE,SPECIES_NONE,SPECIES_NONE,SPECIES_NONE,SPECIES_NONE,SPECIES_NONE,
	 SPECIES_NONE,SPECIES_NONE,SPECIES_NONE,SPECIES_NONE,SPECIES_NONE,SPECIES_NONE, SPECIES_NONE};
	 
	u16 Waterspecies[] = 
	{SPECIES_JISSM, SPECIES_DUGGAME, SPECIES_PLATERRY, SPECIES_FLOOTEY, SPECIES_FREDDIFER,
	SPECIES_DEBEGUCK, SPECIES_BASSHOP,SPECIES_SHEMUE, SPECIES_DABBOI, SPECIES_JANK,
	SPECIES_CIGHTED, SPECIES_SEAWEE, SPECIES_WAILE, SPECIES_COFFICRAB,SPECIES_BAITORD,
	SPECIES_SCUBITE, SPECIES_BREWFIN, SPECIES_SHRIMPOT, SPECIES_PADDLITE,SPECIES_BABINION,
	SPECIES_PIRAGHOUL, SPECIES_OROFLOW,	SPECIES_SQUIGGA,SPECIES_CHOCCUDLE, SPECIES_STROLOKE};
