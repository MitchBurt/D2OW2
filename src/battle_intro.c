...
static const TaskFunc sBattleIntroSlideFuncs[] =
{
    ...
    BattleIntroSlide1, // BATTLE_TERRAIN_GRASS_DUSK
    BattleIntroSlide1, // BATTLE_TERRAIN_GRASS_NIGHT
	BattleIntroSlide1, // BATTLE_TERRAIN_ICE
	BattleIntroSlide1, // BATTLE_TERRAIN_FOREST
};
...
void HandleIntroSlide(u8 terrain)
{
    ...
    else if ((gBattleTypeFlags & BATTLE_TYPE_KRAKRUM_NOIRNET) && gGameVersion != VERSION_RUBY)
    {
