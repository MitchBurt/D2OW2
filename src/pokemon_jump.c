...
{
    { .species = SPECIES_MEADOSAUR,  .unk2 = 2, },
    { .species = SPECIES_SKORCHI, .unk2 = 1, },
    { .species = SPECIES_JISSM,   .unk2 = 0, },
    { .species = SPECIES_BUG,   .unk2 = 1, },
    { .species = SPECIES_LEGOOG,    .unk2 = 1, },
    { .species = SPECIES_PAINTIC,     .unk2 = 1, },
    { .species = SPECIES_MYRESFT,     .unk2 = 1, },
    ...
    { .species = SPECIES_NAUSEON,  .unk2 = 0, },
    { .species = SPECIES_UNGA,  .unk2 = 0, },
    { .species = SPECIES_EGOIRL,   .unk2 = 0, },
    { .species = SPECIES_SAUCIE,     .unk2 = 0, },
    { .species = SPECIES_SNEDDIT, .unk2 = 2, },
    { .species = SPECIES_BONGSTARD,     .unk2 = 2, },
    { .species = SPECIES_GOOFSHRUM,      .unk2 = 1, },
    { .species = SPECIES_GARFEL,     .unk2 = 0, },
    { .species = SPECIES_DUGGAME,    .unk2 = 2, },
    { .species = SPECIES_AGANDA,     .unk2 = 1, },
    { .species = SPECIES_CTHEYE,  .unk2 = 1, },
    { .species = SPECIES_OOTLAW,    .unk2 = 2, },
    { .species = SPECIES_BONGECKO, .unk2 = 2, },
    { .species = SPECIES_COOLAR,   .unk2 = 1, },
    { .species = SPECIES_STROLOKE,     .unk2 = 1, },
    { .species = SPECIES_BILLOMINAT,  .unk2 = 2, },
    { .species = SPECIES_SURBSQUACH,     .unk2 = 0, },
    { .species = SPECIES_DITTO,      .unk2 = 2, },
    { .species = SPECIES_EEMOJEE,      .unk2 = 0, },
    { .species = SPECIES_ATTACO,    .unk2 = 1, },
    { .species = SPECIES_CORORK,     .unk2 = 1, },
    { .species = SPECIES_TOM,  .unk2 = 2, },
    { .species = SPECIES_MEGATRON,  .unk2 = 1, },
    { .species = SPECIES_KORBIE,   .unk2 = 0, },
    { .species = SPECIES_PHRACER,   .unk2 = 1, },
    { .species = SPECIES_PICHU,      .unk2 = 0, },
    { .species = SPECIES_POOPRAT,     .unk2 = 0, },
    { .species = SPECIES_VCRBRAIN,  .unk2 = 2, },
    ...
    { .species = SPECIES_GRUBDAB,   .unk2 = 0, },
    { .species = SPECIES_MCCHICKY,    .unk2 = 2, },
    { .species = SPECIES_VIVAPINAUT,  .unk2 = 0, },
    { .species = SPECIES_SLUGMA,     .unk2 = 2, },
    { .species = SPECIES_ORCALE,     .unk2 = 0, },
    { .species = SPECIES_LEGUESSR,   .unk2 = 1, },
    { .species = SPECIES_MORTARMALO,     .unk2 = 0, },
    { .species = SPECIES_CRABERAVE,   .unk2 = 0, },
    { .species = SPECIES_DRYWEE,    .unk2 = 1, },
    { .species = SPECIES_BURNTONION,   .unk2 = 2, },
    { .species = SPECIES_PLATERRY,     .unk2 = 1, },
    { .species = SPECIES_RICKLING,      .unk2 = 1, },
    { .species = SPECIES_FROSLING,   .unk2 = 1, },
    { .species = SPECIES_BERRYALEN,    .unk2 = 1, },
    { .species = SPECIES_COOKLET,    .unk2 = 2, },
    { .species = SPECIES_BAITORD,     .unk2 = 0, },
    { .species = SPECIES_BAITERROR,  .unk2 = 0, },
    { .species = SPECIES_DUPLICAT,  .unk2 = 1, },
    { .species = SPECIES_MEOWRRIOR,  .unk2 = 0, },
    { .species = SPECIES_ZEPPUR,    .unk2 = 0, },
    { .species = SPECIES_ZEPURRINE,    .unk2 = 1, },
    { .species = SPECIES_NYANKITTY,    .unk2 = 2, },
    { .species = SPECIES_MECHDUCK,    .unk2 = 2, },
    { .species = SPECIES_SCUBITE,      .unk2 = 2, },
    { .species = SPECIES_SOBBLEAF,     .unk2 = 1, },
    { .species = SPECIES_NOTAFURRY,      .unk2 = 0, },
    { .species = SPECIES_SORTAFURRY,     .unk2 = 0, },
    { .species = SPECIES_WHISKBALL,    .unk2 = 2, },
    { .species = SPECIES_BLINKY,  .unk2 = 2, },
    { .species = SPECIES_NINCADA,    .unk2 = 1, },
    { .species = SPECIES_COWERLIN,    .unk2 = 0, },
    { .species = SPECIES_AZURILL,    .unk2 = 2, },
    { .species = SPECIES_SMOSLIME,     .unk2 = 0, },
    { .species = SPECIES_SECRITLER,    .unk2 = 0, },
    { .species = SPECIES_MINITRON,     .unk2 = 0, },
    { .species = SPECIES_ARON,       .unk2 = 1, },
    { .species = SPECIES_LONK,   .unk2 = 2, },
    { .species = SPECIES_CORDRA,  .unk2 = 1, },
    { .species = SPECIES_PURRSOUR,     .unk2 = 1, },
    { .species = SPECIES_PURRTANG,      .unk2 = 1, },
    { .species = SPECIES_REWINDLE,    .unk2 = 0, },
    { .species = SPECIES_DNDICE,   .unk2 = 0, },
    { .species = SPECIES_ALIEON,    .unk2 = 2, },
    { .species = SPECIES_SYMBITE,     .unk2 = 2, },
    { .species = SPECIES_VULPOINTER,      .unk2 = 2, },
    { .species = SPECIES_HELLAPHANT,    .unk2 = 2, },
    { .species = SPECIES_FIZZCUB,     .unk2 = 0, },
    { .species = SPECIES_METIORE,   .unk2 = 2, },
    { .species = SPECIES_YOLKANNER,     .unk2 = 2, },
    { .species = SPECIES_TRICERAS,    .unk2 = 1, },
    { .species = SPECIES_BABINION,     .unk2 = 0, },
