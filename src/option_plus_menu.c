...
enum
{
	...
	MENUITEM_MAIN_BIKE_TYPE,
	//MENUITEM_MAIN_GENERIC_CRY,
...
enum
{
	MENUITEM_CUSTOM_CAP_COLOR_R,
	MENUITEM_CUSTOM_CAP_COLOR_G,
	MENUITEM_CUSTOM_CAP_COLOR_B,
...
static void DrawChoices_EnabledDisabledMain(int selection, int y);
static void DrawChoices_EnabledDisabledCustom(int selection, int y);
static void DrawChoices_Transition(int selection, int y);
static void DrawChoices_Sound(int selection, int y);
static void DrawChoices_Music_Region(int selection, int y);
static void DrawChoices_Title_Screen_Mon(int selection, int y);
static void DrawChoices_RoweCries(int selection, int y);
static void DrawChoices_BarSpeed(int selection, int y); //HP and EXP
static void DrawChoices_RGB(int selection, int y); //HP and EXP
static void DrawChoices_FrameType(int selection, int y);
static void DrawChoices_BikeType(int selection, int y);
...
// const data
static const u8 sEqualSignGfx[] = INCBIN_U8("graphics/ui_menu/options_menu/option_menu_equals_sign.4bpp"); // note: this is only used in the Japanese release
static const u16 sOptionMenuBg_Pal[] = {RGB(17, 18, 31)};
static const u16 sOptionMenuText_Pal[] = INCBIN_U16("graphics/ui_menu/options_menu/option_menu_text_custom.gbapal");
...
} static const sItemFunctionsMain[MENUITEM_MAIN_COUNT] =
{
    ...
    [MENUITEM_MAIN_MUSIC]        = {DrawChoices_Music_Region,        ProcessInput_Options_Four},
	[MENUITEM_MAIN_BIKE_TYPE]    = {DrawChoices_BikeType,            ProcessInput_Options_Two},
	//[MENUITEM_MAIN_GENERIC_CRY]  = {DrawChoices_EnabledDisabledMain, ProcessInput_Options_Two},
...
} static const sItemFunctionsCustom[MENUITEM_CUSTOM_COUNT] =
{
    ...
    [MENUITEM_CUSTOM_CAP_COLOR_R]         = {DrawChoices_RGB,                   ProcessInput_Options_Ten},
	[MENUITEM_CUSTOM_CAP_COLOR_G]         = {DrawChoices_RGB,                   ProcessInput_Options_Ten},
	[MENUITEM_CUSTOM_CAP_COLOR_B]         = {DrawChoices_RGB,                   ProcessInput_Options_Ten},
...
static const u8 sText_Music[]           = _("Music Gen");
static const u8 sText_Bike_Type[]       = _("Bike Type");
static const u8 sText_Generic_Cry[]     = _("Use Generic Cry");
...
static const u8 *const sOptionMenuItemsNamesMain[MENUITEM_MAIN_COUNT] =
{
	...
	[MENUITEM_MAIN_BIKE_TYPE]   = sText_Bike_Type,
	//[MENUITEM_MAIN_GENERIC_CRY] = sText_Generic_Cry,
...
static const u8 sText_RedColor[]            = _("Red Color");
static const u8 sText_BlueColor[]           = _("Blue Color");
static const u8 sText_GreenColor[]          = _("Green Color");
...
static const u8 *const sOptionMenuItemsNamesCustom[MENUITEM_CUSTOM_COUNT] =
{
    ...
    [MENUITEM_CUSTOM_CAP_COLOR_R]         = sText_RedColor,
	[MENUITEM_CUSTOM_CAP_COLOR_G]         = sText_GreenColor,
	[MENUITEM_CUSTOM_CAP_COLOR_B]         = sText_BlueColor,
...
static bool8 CheckConditions(int selection)
{
    ...
    case MENU_MAIN:
        ...
        case MENUITEM_MAIN_BIKE_TYPE:       return TRUE;
        //case MENUITEM_MAIN_GENERIC_CRY:     return TRUE;
    ...
    case MENU_CUSTOM:
        ...
        case MENUITEM_CUSTOM_CAP_COLOR_R:         return TRUE;
	    case MENUITEM_CUSTOM_CAP_COLOR_G:         return TRUE;
	    case MENUITEM_CUSTOM_CAP_COLOR_B:         return TRUE;
...
static const u8 sText_Desc_Music[]              = _("Changes the BGM to use an specific\nregion music.");
static const u8 sText_Desc_Bike[]               = _("Choose the bike type that you want\nto use.");
static const u8 sText_Desc_GenericCry_Ena[]     = _("Use a cry depending on the Pokémon\negg group.");
static const u8 sText_Desc_GenericCry_Dis[]     = _("Most Pokémon will be mute.");
static const u8 *const sOptionMenuItemDescriptionsMain[MENUITEM_MAIN_COUNT][3] =
{
    ...
    [MENUITEM_MAIN_MUSIC]       = {sText_Desc_Music,                sText_Empty,                sText_Empty},
    [MENUITEM_MAIN_BIKE_TYPE]   = {sText_Desc_Bike,                 sText_Empty,                sText_Empty},
    //[MENUITEM_MAIN_GENERIC_CRY] = {sText_Desc_GenericCry_Ena,       sText_Desc_GenericCry_Dis,  sText_Empty},
...
static const u8 sText_Desc_Color[]              = _("Choose the color intensity of\nyour Character.");
...
static const u8 *const sOptionMenuItemDescriptionsCustom[MENUITEM_CUSTOM_COUNT][2] =
{
    ...
    [MENUITEM_CUSTOM_CAP_COLOR_R]        = {sText_Desc_Color,              sText_Empty},
	[MENUITEM_CUSTOM_CAP_COLOR_G]        = {sText_Desc_Color,              sText_Empty},
	[MENUITEM_CUSTOM_CAP_COLOR_B]        = {sText_Desc_Color,              sText_Empty},
...
static const u8 sText_Desc_Disabled_BattleStyle[]   = _("You can only use Set Battle style\nin Hard Mode!.");
static const u8 *const sOptionMenuItemDescriptionsDisabledMain[MENUITEM_MAIN_COUNT] =
{
    ...
    [MENUITEM_MAIN_BIKE_TYPE]   = sText_Empty,
    //[MENUITEM_MAIN_GENERIC_CRY] = sText_Empty,
...
static const u8 *const sOptionMenuItemDescriptionsDisabledCustom[MENUITEM_CUSTOM_COUNT] =
{
    ...
    [MENUITEM_CUSTOM_CAP_COLOR_R]        = sText_Empty,
	[MENUITEM_CUSTOM_CAP_COLOR_G]        = sText_Empty,
	[MENUITEM_CUSTOM_CAP_COLOR_B]        = sText_Empty,
    [MENUITEM_CUSTOM_TITLE_SCREEN]       = sText_Empty,
    [MENUITEM_CUSTOM_TRANSITION]         = sText_Empty,
	[MENUITEM_CUSTOM_SHOW_DAMAGE]        = sText_Empty,
	[MENUITEM_CUSTOM_AUTOMATIC_FOLLOWER] = sText_Empty,
	[MENUITEM_CUSTOM_ROWECRIES]          = sText_Empty,
...
static const u8 *const OptionTextDescription(void)
{
    ...
    case MENU_MAIN:
        ...
        //Only one Description for all the options
        if (menuItem == MENUITEM_MAIN_TEXTSPEED || 
            menuItem == MENUITEM_MAIN_MUSIC || 
            menuItem == MENUITEM_MAIN_BIKE_TYPE || 
    ...
    case MENU_CUSTOM:
        ...
        if (menuItem == MENUITEM_CUSTOM_HP_BAR || 
            menuItem == MENUITEM_CUSTOM_CAP_COLOR_R || 
            menuItem == MENUITEM_CUSTOM_CAP_COLOR_G || 
            menuItem == MENUITEM_CUSTOM_CAP_COLOR_B || 
            menuItem == MENUITEM_CUSTOM_TITLE_SCREEN || 
            menuItem == MENUITEM_CUSTOM_TRANSITION || 
            menuItem == MENUITEM_CUSTOM_SHOW_DAMAGE || 
            menuItem == MENUITEM_CUSTOM_AUTOMATIC_FOLLOWER || 
            menuItem == MENUITEM_CUSTOM_ROWECRIES || 
            menuItem == MENUITEM_CUSTOM_EXP_BAR)
            selection = 0;
...
void CB2_InitOptionPlusMenu(void)
{
    ...
    case 6:
        ...
        if(!FlagGet(FLAG_HARD_MODE))
            ...
            sOptions->sel[MENUITEM_MAIN_BATTLESTYLE] = OPTIONS_BATTLE_STYLE_SET;
        
        sOptions->sel[MENUITEM_MAIN_SOUND]       = gSaveBlock2Ptr->optionsSound;
        sOptions->sel[MENUITEM_MAIN_MUSIC]       = gSaveBlock2Ptr->optionsDifficulty;
        sOptions->sel[MENUITEM_MAIN_BIKE_TYPE]   = gSaveBlock2Ptr->optionsBikeType;
        //sOptions->sel[MENUITEM_MAIN_GENERIC_CRY] = gSaveBlock2Ptr->optionsGenericCry;
        ...
        sOptions->sel_custom[MENUITEM_CUSTOM_CAP_COLOR_R]        = gSaveBlock2Ptr->playerRGB[0];
	    sOptions->sel_custom[MENUITEM_CUSTOM_CAP_COLOR_G]        = gSaveBlock2Ptr->playerRGB[1];
	    sOptions->sel_custom[MENUITEM_CUSTOM_CAP_COLOR_B]        = gSaveBlock2Ptr->playerRGB[2];
...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    gSaveBlock2Ptr->optionsDifficulty       = sOptions->sel[MENUITEM_MAIN_MUSIC];
    gSaveBlock2Ptr->optionsBikeType         = sOptions->sel[MENUITEM_MAIN_BIKE_TYPE];
    //gSaveBlock2Ptr->optionsGenericCry       = sOptions->sel[MENUITEM_MAIN_GENERIC_CRY];
    ...
    gSaveBlock2Ptr->playerRGB[0]                    = sOptions->sel_custom[MENUITEM_CUSTOM_CAP_COLOR_R];
	gSaveBlock2Ptr->playerRGB[1]                    = sOptions->sel_custom[MENUITEM_CUSTOM_CAP_COLOR_G];
	gSaveBlock2Ptr->playerRGB[2]                    = sOptions->sel_custom[MENUITEM_CUSTOM_CAP_COLOR_B];
...
static void DrawChoices_Options_Four(const u8 *const *const strings, int selection, int y, bool8 active)
{
    ...
    styles[selection] = 1;
    xMid = GetMiddleX(strings[order[0]], strings[order[1]], strings[order[2]]) + 2;
    ...
    DrawOptionMenuChoice(strings[order[2]], GetStringRightAlignXOffset(1, strings[order[2]], 198) + 2, y, styles[order[2]], active);
}
...
static const u8 *const sTextMusicStrings[] = {gText_Region_Kanto, gText_Region_Jotho, gText_Region_Hoenn, gText_Region_Sinnoh};
static void DrawChoices_Music_Region(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_MAIN_MUSIC);
    switch(selection){
        case 0:
            DrawOptionMenuChoice(gText_Region_Kanto, 104, y, 1, active);
        break;
        case 1:
            DrawOptionMenuChoice(gText_Region_Jotho, 104, y, 1, active);
        break;
        case 2:
            DrawOptionMenuChoice(gText_Region_Hoenn, 104, y, 1, active);
        break;
        case 3:
            DrawOptionMenuChoice(gText_Region_Sinnoh, 104, y, 1, active);
        break;
    }
}
...
static void DrawChoices_Title_Screen_Mon(int selection, int y)
{
    ...
    switch(selection){
        ...
        break;
        case 2:
            DrawOptionMenuChoice(gText_TitleScreen_Kyogre, 104, y, 1, active);
        break;
    }
}


const u8 gText_Options_Disabled[] = _("Disabled");
static const u8 sText_GenericCries[] = _("Generic");
static const u8 sText_AnimeCries[] = _("Anime(Mgba Only)");
static const u8 sText_NormalCries[] = _("Normal(Mgba Only)");
const u8 gText_Options_Enable[]  = _("Enable");
const u8 gText_Options_Disable[] = _("Disable");

static void DrawChoices_RoweCries(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CUSTOM_ROWECRIES);
    switch(selection){
        case 0:
            DrawOptionMenuChoice(gText_Options_Disabled, 104, y, 1, active);
        break;
        case 1:
            DrawOptionMenuChoice(sText_GenericCries, 104, y, 1, active);
        break;
        case 2:
            DrawOptionMenuChoice(sText_NormalCries, 104, y, 1, active);
        break;
        case 3:
            DrawOptionMenuChoice(sText_AnimeCries, 104, y, 1, active);
        break;
    }
}
...
static void DrawChoices_BikeType(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_MAIN_BIKE_TYPE);
    u8 styles[2] = {0};
    styles[selection] = 1;

    DrawOptionMenuChoice(gText_Mach, 104, y, styles[0], active);
    DrawOptionMenuChoice(gText_Acro, GetStringRightAlignXOffset(FONT_NORMAL, gText_Acro, 198), y, styles[1], active);
}

static void DrawChoices_EnabledDisabledMain(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_MAIN_CANCEL);
    u8 styles[2] = {0};
    styles[selection] = 1;

    DrawOptionMenuChoice(gText_Options_Enable, 104, y, styles[0], active);
    DrawOptionMenuChoice(gText_Options_Disable, GetStringRightAlignXOffset(FONT_NORMAL, gText_Options_Disable, 198), y, styles[1], active);
}

static void DrawChoices_EnabledDisabledCustom(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CUSTOM_CANCEL);
    u8 styles[2] = {0};
    styles[selection] = 1;
...
static void DrawChoices_Transition(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CUSTOM_TRANSITION);
    u8 styles[2] = {0};
    styles[selection] = 1;
...
static void DrawChoices_RGB(int selection, int y) //RGB Stuff
{
    bool8 active = CheckConditions(MENUITEM_CUSTOM_CAP_COLOR_R);
