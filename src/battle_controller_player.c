...
static void MoveSelectionDisplaySplitIcon(u8 target);
...
static const u8 Type_Icon_Bug[]       = INCBIN_U8("graphics/battle_interface/custom/types/bug.4bpp"); 
static const u16 Type_Icon_Bug_Pal[]  = INCBIN_U16("graphics/battle_interface/custom/types/bug.gbapal");

static const u8 Type_Icon_Dark[]      = INCBIN_U8("graphics/battle_interface/custom/types/dark.4bpp"); 
static const u16 Type_Icon_Dark_Pal[] = INCBIN_U16("graphics/battle_interface/custom/types/dark.gbapal");

static const u8 Type_Icon_Dragon[]      = INCBIN_U8("graphics/battle_interface/custom/types/dragon.4bpp"); 
static const u16 Type_Icon_Dragon_Pal[] = INCBIN_U16("graphics/battle_interface/custom/types/dragon.gbapal");

static const u8 Type_Icon_Electric[]      = INCBIN_U8("graphics/battle_interface/custom/types/electric.4bpp"); 
static const u16 Type_Icon_Electric_Pal[] = INCBIN_U16("graphics/battle_interface/custom/types/electric.gbapal");

static const u8 Type_Icon_Fairy[]      = INCBIN_U8("graphics/battle_interface/custom/types/fairy.4bpp"); 
static const u16 Type_Icon_Fairy_Pal[] = INCBIN_U16("graphics/battle_interface/custom/types/fairy.gbapal");

static const u8 Type_Icon_Fire[]      = INCBIN_U8("graphics/battle_interface/custom/types/fire.4bpp"); 
static const u16 Type_Icon_Fire_Pal[] = INCBIN_U16("graphics/battle_interface/custom/types/fire.gbapal");

static const u8 Type_Icon_Fighting[]      = INCBIN_U8("graphics/battle_interface/custom/types/fight.4bpp"); 
static const u16 Type_Icon_Fighting_Pal[] = INCBIN_U16("graphics/battle_interface/custom/types/fight.gbapal");

static const u8 Type_Icon_Flying[]      = INCBIN_U8("graphics/battle_interface/custom/types/flying.4bpp"); 
static const u16 Type_Icon_Flying_Pal[] = INCBIN_U16("graphics/battle_interface/custom/types/flying.gbapal");

static const u8 Type_Icon_Ghost[]      = INCBIN_U8("graphics/battle_interface/custom/types/ghost.4bpp"); 
static const u16 Type_Icon_Ghost_Pal[] = INCBIN_U16("graphics/battle_interface/custom/types/ghost.gbapal");

static const u8 Type_Icon_Grass[]      = INCBIN_U8("graphics/battle_interface/custom/types/grass.4bpp"); 
static const u16 Type_Icon_Grass_Pal[] = INCBIN_U16("graphics/battle_interface/custom/types/grass.gbapal");

static const u8 Type_Icon_Ground[]      = INCBIN_U8("graphics/battle_interface/custom/types/ground.4bpp"); 
static const u16 Type_Icon_Ground_Pal[] = INCBIN_U16("graphics/battle_interface/custom/types/ground.gbapal");

static const u8 Type_Icon_Ice[]      = INCBIN_U8("graphics/battle_interface/custom/types/ice.4bpp"); 
static const u16 Type_Icon_Ice_Pal[] = INCBIN_U16("graphics/battle_interface/custom/types/ice.gbapal");

static const u8 Type_Icon_Normal[]      = INCBIN_U8("graphics/battle_interface/custom/types/normal.4bpp"); 
static const u16 Type_Icon_Normal_Pal[] = INCBIN_U16("graphics/battle_interface/custom/types/normal.gbapal");

static const u8 Type_Icon_Poison[]      = INCBIN_U8("graphics/battle_interface/custom/types/poison.4bpp"); 
static const u16 Type_Icon_Poison_Pal[] = INCBIN_U16("graphics/battle_interface/custom/types/poison.gbapal");

static const u8 Type_Icon_Psychic[]      = INCBIN_U8("graphics/battle_interface/custom/types/psychic.4bpp"); 
static const u16 Type_Icon_Psychic_Pal[] = INCBIN_U16("graphics/battle_interface/custom/types/psychic.gbapal");

static const u8 Type_Icon_Rock[]      = INCBIN_U8("graphics/battle_interface/custom/types/rock.4bpp"); 
static const u16 Type_Icon_Rock_Pal[] = INCBIN_U16("graphics/battle_interface/custom/types/rock.gbapal");

static const u8 Type_Icon_Steel[]      = INCBIN_U8("graphics/battle_interface/custom/types/steel.4bpp"); 
static const u16 Type_Icon_Steel_Pal[] = INCBIN_U16("graphics/battle_interface/custom/types/steel.gbapal");
...
static void Task_GiveExpToMon(u8 taskId)
{
    ...
    if (IsDoubleBattle() == TRUE || monId != gBattlerPartyIndexes[battlerId]) // Give exp without moving the expbar.
    {
        ...
        u32 nextLvlExp = gExperienceTables[gBaseStats[GetGrowthRate(species)].growthRate][level + 1];
...
static void Task_PrepareToGiveExpWithExpBar(u8 taskId)
{
    ...
    u32 currLvlExp = gExperienceTables[gBaseStats[GetGrowthRate(species)].growthRate][level];
    u32 expToNextLvl;

    exp -= currLvlExp;
    expToNextLvl = gExperienceTables[gBaseStats[GetGrowthRate(species)].growthRate][level + 1] - currLvlExp;
...
static void sub_8059400(u8 taskId)
{
    ...
    else
    {
        ...
        if (newExpPoints == -1) // The bar has been filled with given exp points.
        {
            ...
            expOnNextLvl = gExperienceTables[gBaseStats[GetGrowthRate(species)].growthRate][level + 1];
...
u8 TypeEffectiveness(struct ChooseMoveStruct *moveInfo, u8 targetId)
{
	if (gBattleMoves[moveInfo->moves[gMoveSelectionCursor[gActiveBattler]]].power == 0 || 
	    gBattleMoves[moveInfo->moves[gMoveSelectionCursor[gActiveBattler]]].effect == EFFECT_HIDDEN_POWER)
		return 10;
	else
	{
...
u8 GetMoveTypeEffectiveness(u16 moveNum, u8 targetId, u8 userId)
{
	...
	{
        u16 speciesId = GetFormSpeciesId(gBattleMons[userId].species, gBattleMons[userId].formId);
        u16 ability = gBattleMons[userId].ability;
        u8 moveType;
        u16 mod;

        VarSet(VAR_SIGNATURE_MOVE_TEMP, userId);
        moveType = getMoveType(moveNum, speciesId, ability);

        if(moveNum == MOVE_HIDDEN_POWER || moveNum == MOVE_SECRET_POWER){
            u8 typeBits  = ((GetMonData(&gPlayerParty[gBattlerPartyIndexes[userId]], MON_DATA_HP_IV) & 1) << 0)
                        | ((GetMonData(&gPlayerParty[gBattlerPartyIndexes[userId]], MON_DATA_ATK_IV) & 1) << 1)
                        | ((GetMonData(&gPlayerParty[gBattlerPartyIndexes[userId]], MON_DATA_DEF_IV) & 1) << 2)
                        | ((GetMonData(&gPlayerParty[gBattlerPartyIndexes[userId]], MON_DATA_SPEED_IV) & 1) << 3)
                        | ((GetMonData(&gPlayerParty[gBattlerPartyIndexes[userId]], MON_DATA_SPATK_IV) & 1) << 4)
                        | ((GetMonData(&gPlayerParty[gBattlerPartyIndexes[userId]], MON_DATA_SPDEF_IV) & 1) << 5);
		...
		if (gBattleMoves[moveNum].effect == 275)
		{
			...
			if (gBattleMons[targetId].type2 != gBattleMons[targetId].type1)
			{
				u16 mod4 = sTypeEffectivenessTable[gBattleMoves[moveNum].argument][gBattleMons[targetId].type2];
				MulModifier(&mod, mod4);
			}
		}
...
static void MoveSelectionDisplayMoveTypeDoubles(u8 targetId)
{
    ...
    VarSet(VAR_SIGNATURE_MOVE_TEMP, gActiveBattler);

	if (moveInfo->moves[gMoveSelectionCursor[gActiveBattler]] == MOVE_HIDDEN_POWER ||
		moveInfo->moves[gMoveSelectionCursor[gActiveBattler]] == MOVE_SECRET_POWER )
    {
    ...
    {
        MoveType = getMoveType(move, speciesId, ability);
    }
    ...
    switch(MoveType){
        case TYPE_BUG:
            BlitBitmapToWindow(B_WIN_MOVE_TYPE , Type_Icon_Bug, x, y, 32, 16);
            LoadPalette(Type_Icon_Bug_Pal, 10 * 0x10, 0x20);
        break;
        case TYPE_DARK:
            BlitBitmapToWindow(B_WIN_MOVE_TYPE , Type_Icon_Dark, x, y, 32, 16);
            LoadPalette(Type_Icon_Dark_Pal, 10 * 0x10, 0x20);
        break;
        case TYPE_DRAGON:
            BlitBitmapToWindow(B_WIN_MOVE_TYPE , Type_Icon_Dragon, x, y, 32, 16);
            LoadPalette(Type_Icon_Dragon_Pal, 10 * 0x10, 0x20);
        break;
        case TYPE_ELECTRIC:
            BlitBitmapToWindow(B_WIN_MOVE_TYPE , Type_Icon_Electric, x, y, 32, 16);
            LoadPalette(Type_Icon_Electric_Pal, 10 * 0x10, 0x20);
        break;
        case TYPE_FAIRY:
            BlitBitmapToWindow(B_WIN_MOVE_TYPE , Type_Icon_Fairy, x, y, 32, 16);
            LoadPalette(Type_Icon_Fairy_Pal, 10 * 0x10, 0x20);
        break;
        case TYPE_FIRE:
            BlitBitmapToWindow(B_WIN_MOVE_TYPE , Type_Icon_Fire, x, y, 32, 16);
            LoadPalette(Type_Icon_Fire_Pal, 10 * 0x10, 0x20);
        break;
        case TYPE_FIGHTING:
            BlitBitmapToWindow(B_WIN_MOVE_TYPE , Type_Icon_Fighting, x, y, 32, 16);
            LoadPalette(Type_Icon_Fighting_Pal, 10 * 0x10, 0x20);
        break;
        case TYPE_FLYING:
            BlitBitmapToWindow(B_WIN_MOVE_TYPE , Type_Icon_Flying, x, y, 32, 16);
            LoadPalette(Type_Icon_Flying_Pal, 10 * 0x10, 0x20);
        break;
        case TYPE_GHOST:
            BlitBitmapToWindow(B_WIN_MOVE_TYPE , Type_Icon_Ghost, x, y, 32, 16);
            LoadPalette(Type_Icon_Ghost_Pal, 10 * 0x10, 0x20);
        break;
        case TYPE_GRASS:
            BlitBitmapToWindow(B_WIN_MOVE_TYPE , Type_Icon_Grass, x, y, 32, 16);
            LoadPalette(Type_Icon_Grass_Pal, 10 * 0x10, 0x20);
        break;
        case TYPE_GROUND:
            BlitBitmapToWindow(B_WIN_MOVE_TYPE , Type_Icon_Ground, x, y, 32, 16);
            LoadPalette(Type_Icon_Ground_Pal, 10 * 0x10, 0x20);
        break;
        case TYPE_ICE:
            BlitBitmapToWindow(B_WIN_MOVE_TYPE , Type_Icon_Ice, x, y, 32, 16);
            LoadPalette(Type_Icon_Ice_Pal, 10 * 0x10, 0x20);
        break;
        case TYPE_NORMAL:
            BlitBitmapToWindow(B_WIN_MOVE_TYPE , Type_Icon_Normal, x, y, 32, 16);
            LoadPalette(Type_Icon_Normal_Pal, 10 * 0x10, 0x20);
        break;
        case TYPE_POISON:
            BlitBitmapToWindow(B_WIN_MOVE_TYPE , Type_Icon_Poison, x, y, 32, 16);
            LoadPalette(Type_Icon_Poison_Pal, 10 * 0x10, 0x20);
        break;
        case TYPE_PSYCHIC:
            BlitBitmapToWindow(B_WIN_MOVE_TYPE , Type_Icon_Psychic, x, y, 32, 16);
            LoadPalette(Type_Icon_Psychic_Pal, 10 * 0x10, 0x20);
        break;
        case TYPE_ROCK:
            BlitBitmapToWindow(B_WIN_MOVE_TYPE , Type_Icon_Rock, x, y, 32, 16);
            LoadPalette(Type_Icon_Rock_Pal, 10 * 0x10, 0x20);
        break;
        case TYPE_STEEL:
            BlitBitmapToWindow(B_WIN_MOVE_TYPE , Type_Icon_Steel, x, y, 32, 16);
            LoadPalette(Type_Icon_Steel_Pal, 10 * 0x10, 0x20);
        break;
        case TYPE_WATER:
    ...
    MoveSelectionDisplaySplitIcon(targetId);
}
...
static void MoveSelectionDisplayMoveType(void)
{
    ...
    *(txtPtr)++ = 1;
    ...
    MoveSelectionDisplaySplitIcon(B_POSITION_OPPONENT_LEFT);
}
...
static void PlayerHandleDrawTrainerPic(void)
{
            ...
            switch(GetCostume()){
                ...
                case RS_COSTUME:
                    if(gSaveBlock2Ptr->playerGender == GENDER_MALE)
                        ...
                        trainerPicId = TRAINER_BACK_PIC_RUBY_SAPPHIRE_MAY;
                break;
                case FRLG_COSTUME:
                    if(gSaveBlock2Ptr->playerGender == GENDER_MALE)
                ...
                case BW_COSTUME:
                    if(gSaveBlock2Ptr->playerGender == GENDER_MALE)
                        trainerPicId = TRAINER_BACK_PIC_HILBERT;
                    else
                        trainerPicId = TRAINER_BACK_PIC_LEAF;
                break;
            }
    ...
    else
    {
		...
		LoadPlayerTrainerPalette(gTrainerBackPicPaletteTable[trainerPicId].data, 0x100 + 16 * gActiveBattler, 0x20);//LoadPlayerTrainerPalette
...
static void PlayerHandleTrainerSlide(void)
{
    ...
    position = GetBattlerPosition(gActiveBattler);
    LoadPlayerTrainerPalette(gTrainerBackPicPaletteTable[2].data, 0x100 + 16 * gActiveBattler, 0x20);
    SetMultiuseSpriteTemplateToTrainerBack(trainerPicId, GetBattlerPosition(gActiveBattler));
...
static void PlayerHandleIntroTrainerBallThrow(void)
{
    ...
    switch(GetCostume()){
        case EMERALD_COSTUME:
            if(gSaveBlock2Ptr->playerGender == GENDER_MALE)
                LoadPlayerTrainerPalette(gTrainerBackPicPaletteTable[TRAINER_BACK_PIC_BRENDAN].data, 0x100 + paletteNum * 16, 32);
            else
                LoadPlayerTrainerPalette(gTrainerBackPicPaletteTable[TRAINER_BACK_PIC_MAY].data, 0x100 + paletteNum * 16, 32);
        break;
        case RS_COSTUME:
            if(gSaveBlock2Ptr->playerGender == GENDER_MALE)
                LoadPlayerTrainerPalette(gTrainerBackPicPaletteTable[TRAINER_BACK_PIC_RUBY_SAPPHIRE_BRENDAN].data, 0x100 + paletteNum * 16, 32);
            else
                LoadPlayerTrainerPalette(gTrainerBackPicPaletteTable[TRAINER_BACK_PIC_RUBY_SAPPHIRE_MAY].data, 0x100 + paletteNum * 16, 32);
        break;
        case FRLG_COSTUME:
            if(gSaveBlock2Ptr->playerGender == GENDER_MALE)
                LoadPlayerTrainerPalette(gTrainerBackPicPaletteTable[TRAINER_BACK_PIC_RED].data, 0x100 + paletteNum * 16, 32);
            else
                LoadPlayerTrainerPalette(gTrainerBackPicPaletteTable[TRAINER_BACK_PIC_LEAF].data, 0x100 + paletteNum * 16, 32);
        break;
        case BW_COSTUME:
            if(gSaveBlock2Ptr->playerGender == GENDER_MALE)
                LoadPlayerTrainerPalette(gTrainerBackPicPaletteTable[TRAINER_BACK_PIC_HILBERT].data, 0x100 + paletteNum * 16, 32);
            else
                LoadPlayerTrainerPalette(gTrainerBackPicPaletteTable[TRAINER_BACK_PIC_LEAF].data, 0x100 + paletteNum * 16, 32);
        break;
    }
...
static void MoveSelectionDisplaySplitIcon(u8 target){
    ...
    struct ChooseMoveStruct *moveInfo;
	u8 effectiveness;
	static const u8 sEffectiveness_Icon_Zero[] = INCBIN_U8("graphics/battle_interface/custom/effectiveness_zero.4bpp");
    static const u8 sEffectiveness_Icon_Normal[] = INCBIN_U8("graphics/battle_interface/custom/effectiveness_normal.4bpp");
    static const u8 sEffectiveness_Icon_Half[] = INCBIN_U8("graphics/battle_interface/custom/effectiveness_half.4bpp");
    static const u8 sEffectiveness_Icon_Double[] = INCBIN_U8("graphics/battle_interface/custom/effectiveness_double.4bpp");
	static const u8 sSplitIcons_Gfx[] = INCBIN_U8("graphics/battle_interface/custom/split_icons_battle.4bpp");


    // Type Effectiveness ------------------------------------------------------------------------------------------------------
    x = 0;
    y = 0;
    winID = B_WIN_PP_REMAINING;
    FillWindowPixelBuffer(B_WIN_PP_REMAINING, PIXEL_FILL(14));
    FillWindowPixelBuffer(B_WIN_PP, PIXEL_FILL(14));
    FillWindowPixelBuffer(B_WIN_DUMMY, PIXEL_FILL(14));
    ...
    x = 2;
    y = 0;
    icon = GetBattleMoveSplitFromBattler(moveInfo->moves[gMoveSelectionCursor[gActiveBattler]], gActiveBattler);
	//LoadPalette(sSplitIcons_Pal, 10 * 0x10, 0x20);
	BlitBitmapToWindow(winID, sSplitIcons_Gfx + 0x80 * icon, (x * 8), (y * 8), 16, 16);
	PutWindowTilemap(winID);
	CopyWindowToVram(winID, 3);
    ...
    /*/for(i = 0; i < MAX_MON_MOVES; i++){
        switch(i){
            case 0:
                effectiveness = GetMoveTypeEffectiveness(moveInfo->moves[i], target);
                if(effectiveness == MOVE_EFFECTIVENESS_NONE)
	                BlitBitmapToWindow(B_WIN_MOVE_NAME_1 , sEffectiveness_Icon_Zero, (x * 8), (y * 8), 16, 16);
                else if(effectiveness == MOVE_EFFECTIVENESS_HALF)
	                BlitBitmapToWindow(B_WIN_MOVE_NAME_1 , sEffectiveness_Icon_Half, (x * 8), (y * 8), 16, 16);
                else if(effectiveness == MOVE_EFFECTIVENESS_NORMAL)
	                BlitBitmapToWindow(B_WIN_MOVE_NAME_1 , sEffectiveness_Icon_Normal, (x * 8), (y * 8), 16, 16);
                else if(effectiveness == MOVE_EFFECTIVENESS_DOUBLE)
	                BlitBitmapToWindow(B_WIN_MOVE_NAME_1 , sEffectiveness_Icon_Double, (x * 8), (y * 8), 16, 16);
            ...
            case 1:
                effectiveness = GetMoveTypeEffectiveness(moveInfo->moves[i], target);
	            if(effectiveness == MOVE_EFFECTIVENESS_NONE)
	                BlitBitmapToWindow(B_WIN_MOVE_NAME_2 , sEffectiveness_Icon_Zero, (x * 8), (y * 8), 16, 16);
                else if(effectiveness == MOVE_EFFECTIVENESS_HALF)
	                BlitBitmapToWindow(B_WIN_MOVE_NAME_2 , sEffectiveness_Icon_Half, (x * 8), (y * 8), 16, 16);
                else if(effectiveness == MOVE_EFFECTIVENESS_NORMAL)
	                BlitBitmapToWindow(B_WIN_MOVE_NAME_2 , sEffectiveness_Icon_Normal, (x * 8), (y * 8), 16, 16);
                else if(effectiveness == MOVE_EFFECTIVENESS_DOUBLE)
	                BlitBitmapToWindow(B_WIN_MOVE_NAME_2 , sEffectiveness_Icon_Double, (x * 8), (y * 8), 16, 16);
            ...
            case 2:
                effectiveness = GetMoveTypeEffectiveness(moveInfo->moves[i], target);
	            if(effectiveness == MOVE_EFFECTIVENESS_NONE)
	                BlitBitmapToWindow(B_WIN_MOVE_NAME_3 , sEffectiveness_Icon_Zero, (x * 8), (y * 8), 16, 16);
                else if(effectiveness == MOVE_EFFECTIVENESS_HALF)
	                BlitBitmapToWindow(B_WIN_MOVE_NAME_3 , sEffectiveness_Icon_Half, (x * 8), (y * 8), 16, 16);
                else if(effectiveness == MOVE_EFFECTIVENESS_NORMAL)
	                BlitBitmapToWindow(B_WIN_MOVE_NAME_3 , sEffectiveness_Icon_Normal, (x * 8), (y * 8), 16, 16);
                else if(effectiveness == MOVE_EFFECTIVENESS_DOUBLE)
	                BlitBitmapToWindow(B_WIN_MOVE_NAME_3 , sEffectiveness_Icon_Double, (x * 8), (y * 8), 16, 16);
            ...
            case 3:
                effectiveness = GetMoveTypeEffectiveness(moveInfo->moves[i], target);
	            if(effectiveness == MOVE_EFFECTIVENESS_NONE)
	                BlitBitmapToWindow(B_WIN_MOVE_NAME_4 , sEffectiveness_Icon_Zero, (x * 8), (y * 8), 16, 16);
                else if(effectiveness == MOVE_EFFECTIVENESS_HALF)
	                BlitBitmapToWindow(B_WIN_MOVE_NAME_4 , sEffectiveness_Icon_Half, (x * 8), (y * 8), 16, 16);
                else if(effectiveness == MOVE_EFFECTIVENESS_NORMAL)
	                BlitBitmapToWindow(B_WIN_MOVE_NAME_4 , sEffectiveness_Icon_Normal, (x * 8), (y * 8), 16, 16);
                else if(effectiveness == MOVE_EFFECTIVENESS_DOUBLE)
	                BlitBitmapToWindow(B_WIN_MOVE_NAME_4 , sEffectiveness_Icon_Double, (x * 8), (y * 8), 16, 16);
...
static void ChangeMoveDisplayMode(){
    ...
    static const u8 gMovePPText[] =  _("{PP}: {STR_VAR_1}/{STR_VAR_2}");
    ...
    //Move Power
    power = getMoveBasePowerFromMon(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], move);//gBattleMoves[move].power;
    if (power < 2)
        StringCopy(gStringVar1, sText_ThreeDashes);
    else
    ...
    accuracy = getMoveAccuracy(move, GetFormSpeciesId(gBattleMons[gActiveBattler].species, gBattleMons[gActiveBattler].formId));
    if (accuracy == 0)
        StringCopy(gStringVar1, sText_ThreeDashes);
    else
    ...
    SetPpNumbersPaletteInMoveSelection();
    ConvertIntToDecimalStringN(gStringVar1, moveInfo->currentPp[gMoveSelectionCursor[gActiveBattler]], STR_CONV_MODE_RIGHT_ALIGN, 2);
    ConvertIntToDecimalStringN(gStringVar2, moveInfo->maxPp[gMoveSelectionCursor[gActiveBattler]], STR_CONV_MODE_RIGHT_ALIGN, 2);
    StringExpandPlaceholders(gStringVar4, gMovePPText);
