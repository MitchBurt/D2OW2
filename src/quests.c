...
static const struct SideQuest sSideQuests[SIDE_QUEST_COUNT] =
{
    ...
    side_quest(gText_SideQuestName_5,  gText_SideQuestDesc_5,  ITEM_CHARM_VOUCHER		, 1, 	gText_SideQuestHint_5,  FLAG_ACHIEVEMENT_REWARD_05),
    ...
    side_quest(gText_SideQuestName_20, gText_SideQuestDesc_20, ITEM_CHARM_VOUCHER		, 1, 	gText_SideQuestHint_20, FLAG_ACHIEVEMENT_REWARD_20),
    ...
    side_quest(gText_SideQuestName_32, gText_SideQuestDesc_32, ITEM_CHARM_VOUCHER		, 1, 	gText_SideQuestHint_32, FLAG_ACHIEVEMENT_REWARD_32),
    ...
    side_quest(gText_SideQuestName_00, gText_SideQuestDesc_00, ITEM_POKE_BALL	, 1, gText_SideQuestHint_00, FLAG_ACHIEVEMENT_REWARD_01),
    side_quest(gText_SideQuestName_00, gText_SideQuestDesc_00, ITEM_POKE_BALL	, 1, gText_SideQuestHint_00, FLAG_ACHIEVEMENT_REWARD_01),
    side_quest(gText_SideQuestName_96, gText_SideQuestDesc_96, ITEM_CHARM_VOUCHER, 1, gText_SideQuestHint_96, FLAG_ACHIEVEMENT_REWARD_96),
...
static void UnlockQuestMenu(void)
{
	...
	if(	GetSetPokedexFlag(SpeciesToNationalPokedexNum(SPECIES_ODOSAUR), 		FLAG_GET_CAUGHT)	||
		...
		GetSetPokedexFlag(SpeciesToNationalPokedexNum(SPECIES_YEESAUR), 	FLAG_GET_CAUGHT))
